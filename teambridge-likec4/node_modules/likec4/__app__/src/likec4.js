...
import { preferSummary, exact, RichText, ensureSizes } from "@likec4/core/types";
import "react-dom";
...
const conditionsStr = "_hover,_focus,_focusWithin,_focusVisible,_disabled,_active,_visited,_target,_readOnly,_readWrite,_empty,_checked,_enabled,_expanded,_highlighted,_complete,_incomplete,_dragging,_before,_after,_firstLetter,_firstLine,_marker,_selection,_file,_backdrop,_first,_last,_only,_even,_odd,_firstOfType,_lastOfType,_onlyOfType,_peerFocus,_peerHover,_peerActive,_peerFocusWithin,_peerFocusVisible,_peerDisabled,_peerChecked,_peerInvalid,_peerExpanded,_peerPlaceholderShown,_groupFocus,_groupHover,_groupActive,_groupFocusWithin,_groupFocusVisible,_groupDisabled,_groupChecked,_groupExpanded,_groupInvalid,_indeterminate,_required,_valid,_invalid,_autofill,_inRange,_outOfRange,_placeholder,_placeholderShown,_pressed,_selected,_grabbed,_underValue,_overValue,_atValue,_default,_optional,_open,_closed,_fullscreen,_loading,_hidden,_current,_currentPage,_currentStep,_today,_unavailable,_rangeStart,_rangeEnd,_now,_topmost,_motionReduce,_motionSafe,_print,_landscape,_portrait,_dark,_light,_osDark,_osLight,_highContrast,_lessContrast,_moreContrast,_ltr,_rtl,_scrollbar,_scrollbarThumb,_scrollbarTrack,_horizontal,_vertical,_icon,_starting,_noscript,_invertedColors,_shapeSizeXs,_shapeSizeSm,_shapeSizeMd,_shapeSizeLg,_shapeSizeXl,_shapeRectangle,_shapePerson,_shapeBrowser,_shapeMobile,_shapeCylinder,_shapeStorage,_shapeQueue,_shapeBucket,_shapeDocument,_shapeComponent,_notDisabled,_reduceGraphics,_reduceGraphicsOnPan,_noReduceGraphics,_whenPanning,_smallZoom,_compoundTransparent,_edgeActive,_whenHovered,_whenSelectable,_whenSelected,_whenDimmed,_whenFocused,_p3,xs,xsOnly,xsDown,sm,smOnly,smDown,md,mdOnly,mdDown,lg,lgOnly,lgDown,xl,xlOnly,xlDown,xsToSm,xsToMd,xsToLg,xsToXl,smToMd,smToLg,smToXl,mdToLg,mdToXl,lgToXl,@/xs,@/sm,@/md,@/lg,@likec4-root/xs,@likec4-root/sm,@likec4-root/md,@likec4-root/lg,@likec4-dialog/xs,@likec4-dialog/sm,@likec4-dialog/md,@likec4-dialog/lg,base", conditions = new Set(conditionsStr.split(",")), conditionRegex = /^@|&|&$/;
...
function cva(config) {
  const { base, variants: variants2, defaultVariants, compoundVariants } = defaults(config), getVariantProps2 = (variants3) => ({ ...defaultVariants, ...compact(variants3) });
  function resolve(props = {}) {
    const computedVariants = getVariantProps2(props);
    let variantCss = { ...base };
    for (const [key2, value] of Object.entries(computedVariants))
      variants2[key2]?.[value] && (variantCss = mergeCss(variantCss, variants2[key2][value]));
    const compoundVariantCss = getCompoundVariantCss(compoundVariants, computedVariants);
    return mergeCss(variantCss, compoundVariantCss);
  }
  function merge(__cva) {
    const override = defaults(__cva.config), variantKeys2 = uniq(__cva.variantKeys, Object.keys(variants2));
    return cva({
      base: mergeCss(base, override.base),
      variants: Object.fromEntries(
        variantKeys2.map((key2) => [key2, mergeCss(variants2[key2], override.variants[key2])])
      ),
  ...
  const variantMap = Object.fromEntries(Object.entries(variants2).map(([key2, value]) => [key2, Object.keys(value)]));
...
function assertCompoundVariant(name, compoundVariants, variants2, prop) {
  if (compoundVariants.length > 0 && typeof variants2?.[prop] == "object")
...
function sva(config) {
  ...
  const variants2 = config.variants ?? {}, variantKeys = Object.keys(variants2);
  function splitVariantProps(props) {
    return splitProps(props, variantKeys);
  }
  const getVariantProps2 = (variants3) => ({ ...defaultVariants, ...compact(variants3) }), variantMap = Object.fromEntries(
    Object.entries(variants2).map(([key2, value]) => [key2, Object.keys(value)])
  );
...
const __iconNode$x = [["path", { d: "M4 20l16 0", key: "svg-0" }], ["path", { d: "M9 6a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v8a2 2 0 0 1 -2 2h-2a2 2 0 0 1 -2 -2l0 -8", key: "svg-1" }]], IconLayoutAlignBottom = createReactComponent("outline", "layout-align-bottom", "LayoutAlignBottom", __iconNode$x);
const __iconNode$w = [["path", { d: "M12 4l0 5", key: "svg-0" }], ["path", { d: "M12 15l0 5", key: "svg-1" }], ["path", { d: "M6 11a2 2 0 0 1 2 -2h8a2 2 0 0 1 2 2v2a2 2 0 0 1 -2 2h-8a2 2 0 0 1 -2 -2l0 -2", key: "svg-2" }]], IconLayoutAlignCenter = createReactComponent("outline", "layout-align-center", "LayoutAlignCenter", __iconNode$w);
const __iconNode$v = [["path", { d: "M4 4l0 16", key: "svg-0" }], ["path", { d: "M8 11a2 2 0 0 1 2 -2h8a2 2 0 0 1 2 2v2a2 2 0 0 1 -2 2h-8a2 2 0 0 1 -2 -2l0 -2", key: "svg-1" }]], IconLayoutAlignLeft = createReactComponent("outline", "layout-align-left", "LayoutAlignLeft", __iconNode$v);
const __iconNode$u = [["path", { d: "M4 12l5 0", key: "svg-0" }], ["path", { d: "M15 12l5 0", key: "svg-1" }], ["path", { d: "M9 8a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v8a2 2 0 0 1 -2 2h-2a2 2 0 0 1 -2 -2l0 -8", key: "svg-2" }]], IconLayoutAlignMiddle = createReactComponent("outline", "layout-align-middle", "LayoutAlignMiddle", __iconNode$u);
const __iconNode$t = [["path", { d: "M20 4l0 16", key: "svg-0" }], ["path", { d: "M4 11a2 2 0 0 1 2 -2h8a2 2 0 0 1 2 2v2a2 2 0 0 1 -2 2h-8a2 2 0 0 1 -2 -2l0 -2", key: "svg-1" }]], IconLayoutAlignRight = createReactComponent("outline", "layout-align-right", "LayoutAlignRight", __iconNode$t);
const __iconNode$s = [["path", { d: "M4 4l16 0", key: "svg-0" }], ["path", { d: "M9 10a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v8a2 2 0 0 1 -2 2h-2a2 2 0 0 1 -2 -2l0 -8", key: "svg-1" }]], IconLayoutAlignTop = createReactComponent("outline", "layout-align-top", "LayoutAlignTop", __iconNode$s);
const __iconNode$r = [["path", { d: "M4 6a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2l0 -12", key: "svg-0" }], ["path", { d: "M4 12h8", key: "svg-1" }], ["path", { d: "M12 15h8", key: "svg-2" }], ["path", { d: "M12 9h8", key: "svg-3" }], ["path", { d: "M12 4v16", key: "svg-4" }]], IconLayoutBoardSplit = createReactComponent("outline", "layout-board-split", "LayoutBoardSplit", __iconNode$r);
const __iconNode$q = [["path", { d: "M4 6a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2l0 -12", key: "svg-0" }], ["path", { d: "M10 4l4 16", key: "svg-1" }], ["path", { d: "M12 12l-8 2", key: "svg-2" }]], IconLayoutCollage = createReactComponent("outline", "layout-collage", "LayoutCollage", __iconNode$q);
...
const __iconNode$n = [["path", { d: "M3 13a2 2 0 0 1 2 -2h10a2 2 0 0 1 2 2v6a2 2 0 0 1 -2 2h-10a2 2 0 0 1 -2 -2l0 -6", key: "svg-0" }], ["path", { d: "M9 16a1 1 0 1 0 2 0a1 1 0 0 0 -2 0", key: "svg-1" }], ["path", { d: "M13 11v-4a4 4 0 1 1 8 0v4", key: "svg-2" }]], IconLockOpen2 = createReactComponent("outline", "lock-open-2", "LockOpen2", __iconNode$n);
const __iconNode$m = [["path", { d: "M5 13a2 2 0 0 1 2 -2h10a2 2 0 0 1 2 2v6a2 2 0 0 1 -2 2h-10a2 2 0 0 1 -2 -2v-6", key: "svg-0" }], ["path", { d: "M11 16a1 1 0 1 0 2 0a1 1 0 0 0 -2 0", key: "svg-1" }], ["path", { d: "M8 11v-4a4 4 0 1 1 8 0v4", key: "svg-2" }]], IconLock = createReactComponent("outline", "lock", "Lock", __iconNode$m);
const __iconNode$l = [["path", { d: "M12 3c.132 0 .263 0 .393 0a7.5 7.5 0 0 0 7.92 12.446a9 9 0 1 1 -8.313 -12.454l0 .008", key: "svg-0" }], ["path", { d: "M17 4a2 2 0 0 0 2 2a2 2 0 0 0 -2 2a2 2 0 0 0 -2 -2a2 2 0 0 0 2 -2", key: "svg-1" }], ["path", { d: "M19 11h2m-1 -1v2", key: "svg-2" }]], IconMoonStars = createReactComponent("outline", "moon-stars", "MoonStars", __iconNode$l);
const __iconNode$k = [["path", { d: "M21 14.008v-5.018a1.98 1.98 0 0 0 -1 -1.717l-4 -2.008a2.016 2.016 0 0 0 -2 0l-10 5.008c-.619 .355 -1 1.01 -1 1.718v5.018c0 .709 .381 1.363 1 1.717l4 2.008a2.016 2.016 0 0 0 2 0l10 -5.008c.619 -.355 1 -1.01 1 -1.718", key: "svg-0" }], ["path", { d: "M9 21v-7.5", key: "svg-1" }], ["path", { d: "M9 13.5l11.5 -5.5", key: "svg-2" }], ["path", { d: "M3.5 11l5.5 2.5", key: "svg-3" }]], IconRectangularPrism = createReactComponent("outline", "rectangular-prism", "RectangularPrism", __iconNode$k);
const __iconNode$j = [["path", { d: "M3 16a1 1 0 0 1 1 -1h2a1 1 0 0 1 1 1v2a1 1 0 0 1 -1 1h-2a1 1 0 0 1 -1 -1l0 -2", key: "svg-0" }], ["path", { d: "M10 16a1 1 0 0 1 1 -1h2a1 1 0 0 1 1 1v2a1 1 0 0 1 -1 1h-2a1 1 0 0 1 -1 -1l0 -2", key: "svg-1" }], ["path", { d: "M17 16a1 1 0 0 1 1 -1h2a1 1 0 0 1 1 1v2a1 1 0 0 1 -1 1h-2a1 1 0 0 1 -1 -1l0 -2", key: "svg-2" }], ["path", { d: "M5 11v-3a3 3 0 0 1 3 -3h8a3 3 0 0 1 3 3v3", key: "svg-3" }], ["path", { d: "M16.5 8.5l2.5 2.5l2.5 -2.5", key: "svg-4" }]], IconReorder = createReactComponent("outline", "reorder", "Reorder", __iconNode$j);
const __iconNode$i = [["path", { d: "M4 19a2 2 0 1 0 4 0a2 2 0 1 0 -4 0", key: "svg-0" }], ["path", { d: "M16 5a2 2 0 1 0 4 0a2 2 0 1 0 -4 0", key: "svg-1" }], ["path", { d: "M12 19h4.5c.71 0 1.372 -.212 1.924 -.576m1.545 -2.459a3.5 3.5 0 0 0 -3.469 -3.965h-.499m-4 0h-3.501a3.5 3.5 0 0 1 -2.477 -5.972m2.477 -1.028h3.5", key: "svg-2" }], ["path", { d: "M3 3l18 18", key: "svg-3" }]], IconRouteOff = createReactComponent("outline", "route-off", "RouteOff", __iconNode$i);
const __iconNode$h = [["path", { d: "M3 10a7 7 0 1 0 14 0a7 7 0 1 0 -14 0", key: "svg-0" }], ["path", { d: "M21 21l-6 -6", key: "svg-1" }]], IconSearch = createReactComponent("outline", "search", "Search", __iconNode$h);
const __iconNode$g = [["path", { d: "M8 9l4 -4l4 4", key: "svg-0" }], ["path", { d: "M16 15l-4 4l-4 -4", key: "svg-1" }]], IconSelector = createReactComponent("outline", "selector", "Selector", __iconNode$g);
const __iconNode$f = [["path", { d: "M3 12a3 3 0 1 0 6 0a3 3 0 1 0 -6 0", key: "svg-0" }], ["path", { d: "M15 6a3 3 0 1 0 6 0a3 3 0 1 0 -6 0", key: "svg-1" }], ["path", { d: "M15 18a3 3 0 1 0 6 0a3 3 0 1 0 -6 0", key: "svg-2" }], ["path", { d: "M8.7 10.7l6.6 -3.4", key: "svg-3" }], ["path", { d: "M8.7 13.3l6.6 3.4", key: "svg-4" }]], IconShare = createReactComponent("outline", "share", "Share", __iconNode$f);
const __iconNode$e = [["path", { d: "M12 4l-8 4l8 4l8 -4l-8 -4", key: "svg-0" }], ["path", { d: "M4 12l8 4l8 -4", key: "svg-1" }], ["path", { d: "M4 16l8 4l8 -4", key: "svg-2" }]], IconStack2 = createReactComponent("outline", "stack-2", "Stack2", __iconNode$e);
const __iconNode$d = [["path", { d: "M8 12a4 4 0 1 0 8 0a4 4 0 1 0 -8 0", key: "svg-0" }], ["path", { d: "M3 12h1m8 -9v1m8 8h1m-9 8v1m-6.4 -15.4l.7 .7m12.1 -.7l-.7 .7m0 11.4l.7 .7m-12.1 -.7l-.7 .7", key: "svg-1" }]], IconSun = createReactComponent("outline", "sun", "Sun", __iconNode$d);
const __iconNode$c = [["path", { d: "M11 12a1 1 0 1 0 2 0a1 1 0 1 0 -2 0", key: "svg-0" }], ["path", { d: "M7 12a5 5 0 1 0 10 0a5 5 0 1 0 -10 0", key: "svg-1" }], ["path", { d: "M3 12a9 9 0 1 0 18 0a9 9 0 1 0 -18 0", key: "svg-2" }]], IconTarget = createReactComponent("outline", "target", "Target", __iconNode$c);
const __iconNode$b = [["path", { d: "M3 6a3 3 0 1 0 6 0a3 3 0 0 0 -6 0", key: "svg-0" }], ["path", { d: "M21 11v-3a2 2 0 0 0 -2 -2h-6l3 3m0 -6l-3 3", key: "svg-1" }], ["path", { d: "M3 13v3a2 2 0 0 0 2 2h6l-3 -3m0 6l3 -3", key: "svg-2" }], ["path", { d: "M15 18a3 3 0 1 0 6 0a3 3 0 0 0 -6 0", key: "svg-3" }]], IconTransform = createReactComponent("outline", "transform", "Transform", __iconNode$b);
const __iconNode$a = [["path", { d: "M4 7l16 0", key: "svg-0" }], ["path", { d: "M10 11l0 6", key: "svg-1" }], ["path", { d: "M14 11l0 6", key: "svg-2" }], ["path", { d: "M5 7l1 12a2 2 0 0 0 2 2h8a2 2 0 0 0 2 -2l1 -12", key: "svg-3" }], ["path", { d: "M9 7v-3a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v3", key: "svg-4" }]], IconTrash = createReactComponent("outline", "trash", "Trash", __iconNode$a);
...
function IconRenderer({
  ...
  if (element.icon.startsWith("http://") || element.icon.startsWith("https://") || element.icon.startsWith("data:image")) {
    const svgContent = element.icon.startsWith("data:image/svg+xml") ? decodeSvgDataUrl(element.icon) : null;
    svgContent ? icon2 = /* @__PURE__ */ jsx("span", { style: { display: "contents" }, dangerouslySetInnerHTML: { __html: svgContent } }) : icon2 = /* @__PURE__ */ jsx("img", { src: element.icon, alt: element.title });
  } else RenderIcon && (icon2 = /* @__PURE__ */ jsx(RenderIcon, { node: element }));
  return icon2 ? /* @__PURE__ */ jsx(
    "div",
    {
      className: cx(
        className,
...
function IconOrShapeRenderer({
  ...
  return /* @__PURE__ */ jsx(IconRenderer, { element, className, style });
}
...
function useCallbackRef(callback) {
  ...
  return ref.current = callback, useMemo(() => {
    function callbackRef(...args) {
...
function getNodeIntersectionFromCenterToPoint(intersectionNode, target, nodeMargin = 0) {
  const { width, height } = intersectionNode, nodeCenter = BBox.center(intersectionNode), v = vector(target.x, target.y).subtract(nodeCenter), xScale = (nodeMargin + width / 2) / v.x, yScale = (nodeMargin + height / 2) / v.y, scale = Math.min(Math.abs(xScale), Math.abs(yScale));
...
function isSamePoint(a, b) {
  if (a === b)
    return !0;
  const [ax, ay] = e(a) ? a : [a.x, a.y], [bx, by] = e(b) ? b : [b.x, b.y];
  return Math.hypot(bx - ax, by - ay) < 2.1;
}
function stopPropagation$1(e2) {
  e2.nativeEvent.stopImmediatePropagation(), e2.stopPropagation();
}
const printPoint = (point) => `${Math.trunc(point[0])},${Math.trunc(point[1])}`;
function bezierPath(bezierSpline) {
  ...
  for (; t$1(points, 3); ) {
    ...
    path = path + ` C ${printPoint(cp1)} ${printPoint(cp2)} ${printPoint(end)}`, points = rest;
  }
...
function _update(current, updated) {
  return current === updated ? current : (updated = updated.map((update) => {
    ...
    const isSameData = n(existing.data, update.data);
    let data2 = isSameData ? existing.data : update.data;
    isSameData || (e$1(existing.data.hovered) && !e$1(update.data.hovered) && (data2 = {
      ...data2,
      hovered: existing.data.hovered
    }), e$1(existing.data.dimmed) && !e$1(update.data.dimmed) && (data2 = {
      ...data2,
    ...
    return {
      ...
      ...t$2(existing, (v, k) => e$1(v) && k !== "parentId" && k !== "handles"),
  ...
  }), shallowEqual(current, updated) ? current : updated);
}
...
const RootContainerContext = createContext$1(null), RootContainerContextProvider = RootContainerContext.Provider;
...
const ReduceGraphicsModeCtx = createContext$1(null), ReduceGraphicsModeProvider = ReduceGraphicsModeCtx.Provider;
...
function RootContainer({
  ...
  const ref = useRef(null), [$isPanning] = useState(() => atom(!1)), isPanning = useStore$1($isPanning), ctx = useMemo(() => ({ id, ref, selector: `#${id}` }), [id, ref]);
  return /* @__PURE__ */ jsx(ReduceGraphicsModeProvider, { value: reduceGraphics, children: /* @__PURE__ */ jsx(PanningAtomSafeCtx, { value: $isPanning, children: /* @__PURE__ */ jsx(
    "div",
    {
      id,
      ...
      children: /* @__PURE__ */ jsx(RootContainerContextProvider, { value: ctx, children })
    }
  ) }) });
}
...
}, HandlerNames = t$5(defaultHandlers), DiagramEventHandlersRefContext = createContext$1({
  current: defaultHandlers
}), DiagramEventHandlersReactContext = createContext$1({
  ...t$4(HandlerNames, (name) => [name, null]),
  handlersRef: {
    current: defaultHandlers
  }
});
function DiagramEventHandlers({
  ...
  const handlersRef = useSyncedRef(
    ...
    ...t$4(HandlerNames, (name) => handlersRef.current[name] ? [name, (...args) => handlersRef.current[name]?.(...args)] : [name, null]),
    handlersRef
  }), [handlersRef, ...deps]);
  return /* @__PURE__ */ jsx(DiagramEventHandlersRefContext.Provider, { value: handlersRef, children: /* @__PURE__ */ jsx(DiagramEventHandlersReactContext.Provider, { value, children }) });
}
...
function useSetState(initialState, equal) {
  const [state, _setState] = useState(initialState), equalFn = equal ?? shallowEqual, equalFnRef = useRef(equalFn);
...
const DefaultFeatures = {
  ...
  enableElementTags: !1,
  enableNotes: !1
}, DiagramFeaturesContext = createContext$1(DefaultFeatures);
function DiagramFeatures({
  children,
  features,
  overrides
}) {
  const outerScope = useContext(DiagramFeaturesContext), [scope, setScope] = useSetState(() => ({
    ...outerScope,
    ...features,
    ...overrides
  }));
...
function DefaultMantineProvider({
  children,
  theme,
  ...props
}) {
...
function EnsureMantine({ children }) {
  ...
  }, []), mantineCtx ? /* @__PURE__ */ jsx(Fragment, { children }) : /* @__PURE__ */ jsx(DefaultMantineProvider, { children });
}
...
}, DiagramActorSafeContext = createContext$1(null);
DiagramActorSafeContext.displayName = "DiagramActorSafeContext";
const DiagramApiSafeContext = createContext$1(null);
...
function useDiagramSnapshot(selector3, compare2 = shallowEqual) {
  const actorRef = useDiagramActorRef();
  return useSelector(actorRef, selector3, compare2);
}
function selectDiagramActorContext(selector3) {
  return (state) => selector3(state.context);
}
...
const selectView$1 = (s) => s.context.view;
function useCurrentView() {
  return useDiagramSnapshot(selectView$1);
}
const LikeC4ModelContext = createContext$1(null), LikeC4ModelContextProvider = LikeC4ModelContext.Provider, CurrentViewModelCtx = createContext$1(null), CurrentViewModelContext = CurrentViewModelCtx.Provider;
...
function CurrentViewModelProvider({ children }) {
  const viewId = useCurrentViewId(), viewmodel = useOptionalLikeC4Model()?.findView(viewId) ?? null;
  return /* @__PURE__ */ jsx(CurrentViewModelContext, { value: viewmodel, children });
}
...
function useLikeC4Specification() {
  const _specification = useLikeC4Model().specification, [specification, setSpecification] = useState(_specification);
  return useEffect(() => {
    setSpecification((current) => deepEqual(current, _specification) ? current : _specification);
  }, [_specification]), specification;
}
const TagStylesContext = createContext$1({}), radixColors = DefaultTagColors, generateColorVars = (spec) => {
...
function TagStylesProvider({ children, rootSelector }) {
  const tags = useLikeC4Specification().tags, nonce = useMantineStyleNonce()?.(), stylesheet = generateStylesheet(tags, rootSelector);
  return /* @__PURE__ */ jsxs(TagStylesContext.Provider, { value: tags, children: [
    stylesheet !== "" && /* @__PURE__ */ jsx(TagStylesheet, { nonce, stylesheet }),
    children
  ] });
}
const TagStylesheet = memo$1(({ stylesheet, nonce }) => /* @__PURE__ */ jsx(
  "style",
  {
    "data-likec4-tags": !0,
    type: "text/css",
...
const LikeC4EditorReactContext = createContext$1(null);
function LikeC4EditorProvider({ children, editor: editor2 }) {
  return /* @__PURE__ */ jsx(LikeC4EditorReactContext.Provider, { value: editor2, children });
}
...
}, Flex = /* @__PURE__ */ forwardRef(function(props, ref) {
  const [patternProps, restProps] = splitProps(props, ["align", "justify", "direction", "wrap", "basis", "grow", "shrink"]), styleProps = getFlexStyle(patternProps), mergedProps = { ref, ...styleProps, ...restProps };
  return createElement(styled.div, mergedProps);
}), vstackConfig = {
  transform(props) {
...
}, container$2 = (styles) => css(getContainerStyle(styles));
container$2.raw = getContainerStyle;
const bleedConfig = {
...
const txtConfig = {
  transform(props, _helpers) {
    const { inline, size: size2, dimmed, lh, likec4color, ...rest } = props;
    if (dimmed && likec4color)
      throw new Error("dimmed and likec4color are mutually exclusive");
    return {
      userSelect: "all",
      cursor: "default",
      textStyle: dimmed ? `dimmed.${size2}` : size2,
  ...
  defaultValues: { inline: !1, dimmed: !1, size: "md" }
}, getTxtStyle = (styles = {}) => {
  const _styles = getPatternStyles(txtConfig, styles);
  return txtConfig.transform(_styles, patternFns);
}, txt = (styles) => css(getTxtStyle(styles));
txt.raw = getTxtStyle;
const Txt = /* @__PURE__ */ forwardRef(function(props, ref) {
  const [patternProps, restProps] = splitProps(props, ["inline", "dimmed", "lh", "size", "likec4color"]), styleProps = getTxtStyle(patternProps), mergedProps = { ref, ...styleProps, ...restProps };
  return createElement(styled.div, mergedProps);
});
...
const select$2 = (s) => s.children.overlays;
function useOverlaysActorRef() {
  return useDiagramSnapshot(select$2, Object.is);
}
...
}), navigationPanelActorLogic = _actorLogic$1, LikeC4ProjectsContext = createContext$1(null), LikeC4ProjectsContextProvider = LikeC4ProjectsContext.Provider;
...
function useLikeC4Styles() {
  return useOptionalLikeC4Model()?.$styles ?? LikeC4Styles$1.DEFAULT;
}
function pickViewBounds(view, dynamicVariant) {
  if (view._type === "dynamic")
    try {
      if ((dynamicVariant ?? view.variant) === "sequence")
        return invariant$1(view.sequenceLayout, "Sequence layout is not available"), invariant$1(view.sequenceLayout.bounds, "Sequence layout bounds are not available"), view.sequenceLayout.bounds;
    } catch (error) {
      console.error(error);
    }
  return view.bounds;
...
function createViewChange(parentContext) {
  const {
    ...
    const data2 = xyedge.data;
    let controlPoints = data2.controlPoints ?? [];
    const sourceOrTargetMoved = movedNodes.has(xyedge.source) || movedNodes.has(xyedge.target);
    controlPoints.length === 0 && sourceOrTargetMoved && (controlPoints = bezierControlPoints(data2.points));
    const _updated = {
      ...edge,
      points: data2.points
    };
    return data2.labelBBox ? _updated.labelBBox = {
      x: Math.round(data2.labelBBox.x),
      y: Math.round(data2.labelBBox.y),
      width: Math.round(data2.labelBBox.width),
      height: Math.round(data2.labelBBox.height)
    } : _updated.labelBBox = null, t$1(controlPoints, 1) ? _updated.controlPoints = t$a(controlPoints, (v) => ({
      x: Math.round(v.x),
      y: Math.round(v.y)
    })) : _updated.controlPoints = null, _updated;
  });
  return {
...
const hotkeyActorLogic$1 = fromCallback(({ sendBack }) => {
...
}), diagramActorRef$1 = (system) => system.get("diagram"), getDiagramContext = function(system) {
  return system.get("diagram").getSnapshot().context;
}, raiseSync = () => machine$5.raise({ type: "sync" }, { delay: 200, id: "sync" }), cancelSync = () => machine$5.cancel("sync"), reschedule = (delay2 = 350) => machine$5.raise(({ event }) => event, { delay: delay2 }), isLayoutChange = (change) => change.op === "reset-manual-layout" || change.op === "save-view-snapshot", withoutSnapshotChanges = n$2(e$4(isLayoutChange)), saveStateBeforeEdit = () => machine$5.assign(({ system }) => {
  const parentContext = getDiagramContext(system);
  return {
    beforeEditing: {
      xynodes: parentContext.xynodes.map(({ measured, data: data2, ...n2 }) => ({
        ...n$1(n2, ["selected", "dragging", "resizing"]),
        data: n$1(data2, ["dimmed", "hovered"]),
        measured,
        initialWidth: measured?.width ?? n2.width ?? n2.initialWidth,
        initialHeight: measured?.height ?? n2.height ?? n2.initialHeight
      })),
      xyedges: parentContext.xyedges.map(({ data: data2, ...e2 }) => ({
        ...n$1(e2, ["selected"]),
        data: n$1(data2, ["active", "dimmed", "hovered"])
      })),
...
}), startEditing$1 = () => machine$5.enqueueActions(({ enqueue, event }) => {
  enqueue(saveStateBeforeEdit()), event.type === "edit.start" && enqueue.assign({
    editing: event.subject
  });
}), stopHotkey = () => machine$5.stopChild("hotkey"), ensureHotKey = () => machine$5.enqueueActions(({ check, enqueue, self }) => {
...
}), pushHistory = () => machine$5.assign(({ context: context2 }) => {
  ...
  return history.length > 50 && history.shift(), {
    beforeEditing: null,
    editing: null,
    history
  };
}), stopEditing$1 = () => machine$5.enqueueActions(({ event, enqueue }) => {
...
}), markHistoryAsSynched = () => machine$5.assign(({ context: context2 }) => ({
...
})), popHistory = () => machine$5.assign(({ context: context2 }) => context2.history.length <= 1 ? {
  history: []
} : {
  history: context2.history.slice(0, context2.history.length - 1)
}), undo = () => machine$5.enqueueActions(({ context: context2, enqueue, system }) => {
...
}), addSnapshotToPendingChanges = () => machine$5.assign(({ context: context2, system }) => {
...
}, idle$3 = machine$5.createStateConfig({
  id: "idle",
  on: {
    sync: {
      ...to$3.pending
...
}), editing = machine$5.createStateConfig({
  id: "editing",
  tags: "pending",
  entry: [
    startEditing$1(),
...
}), pending = machine$5.createStateConfig({
  id: "pending",
  tags: ["pending"],
  entry: ensureHotKey(),
  on: {
...
}), afterEdit = machine$5.createStateConfig({
  id: "afterEdit",
  always: [
    { guard: "has pending", ...to$3.pending },
    { ...to$3.idle }
  ]
}), applyLatestToManual = machine$5.createStateConfig({
...
}), executeChanges = machine$5.createStateConfig({
  id: "executeChanges",
  entry: [
  ...
  invoke: {
    ...
    onDone: {
      actions: enqueueActions(({ context: context2, event, enqueue }) => {
    ...
    onError: {
      actions: assign(({ event }) => (console.error("executeChanges onError", { error: event.error }), {
        pendingChanges: []
      })),
      ...to$3.idle
    }
  }
}), _editorActorLogic = machine$5.createMachine({
  id: "editor",
  context: ({ input: input2 }) => ({
...
function activeSequenceBounds(params) {
  ...
  return stepBounds ??= getEdgeBounds(stepEdge, xystate), stepBounds ? stepBounds = BBox.merge(stepBounds, actorsBounds) : stepBounds = actorsBounds, {
    duration: 350,
    bounds: BBox.expand(
      stepBounds,
      MARGIN
...
function getEdgeBounds(edge, store) {
  ...
  return edgePosition ? BBox.fromPoints([
...
function findCorrespondingNode(context2, event) {
  const fromNodeId = context2.lastOnNavigate?.fromNode, fromNode = fromNodeId && context2.xynodes.find((n2) => n2.id === fromNodeId), fromRef = fromNode && nodeRef(fromNode);
  if (!fromNode || !fromRef)
    return { fromNode: null, toNode: null };
  const toNode = event.xynodes.find((n2) => nodeRef(n2) === fromRef) ?? null;
...
function createNodes$1(column, elements, g) {
  const graphNodes = new DefaultMap((key2) => ({
    id: `${column}-${key2}`,
    portId: `${column}-${key2}`
  })), tree2 = treeFromElements(elements);
  for (const element of tree2.sorted) {
    const isCompound = tree2.children(element).length > 0, fqn2 = element.id, id = `${column}-${fqn2}`, portId = isCompound ? `${id}${PortSuffix$1}` : id;
    graphNodes.set(fqn2, {
      id,
      portId
    }), g.setNode(id, {
    ...
    const parent = tree2.parent(element);
    parent && g.setParent(id, `${column}-${parent.id}`);
  }
  return {
    ...tree2,
    byId: (id) => {
      const element = tree2.byId(id), graph = graphNodes.get(element.id);
      return {
        element,
        graph
      };
...
function layoutRelationshipsView(data2, scope) {
  const g = createGraph$1(), incomers = createNodes$1("incomers", data2.incomers, g), subjects = createNodes$1("subjects", data2.subjects, g), outgoers = createNodes$1("outgoers", data2.outgoers, g), edges = [];
  t$6(
    t$e(
      t$6(
        toArray(data2.incoming),
        t$a((r2) => ({
          id: r2.source.id,
  ...
  const dagreBounds = applyDagreLayout$1(g), _calculatedNodeBounds = t$6(
    ...
    t$4((n2) => [n2.id, dagreBounds(n2.id)])
  );
...
function useRelationshipsView(subject, viewId, scope) {
  ...
  return useMemo(() => {
    const view = viewId ? model.findView(viewId) : null, data2 = layoutRelationshipsView(
      computeRelationshipsView(subject, model, viewId, scope),
      scope === "view" ? view : null
    );
    return view && (scope === "global" || !data2.subjectExistsInScope) && (data2.edges = data2.edges.map((edge) => (edge.existsInCurrentView = edge.relations.every((r2) => view.includesRelation(r2)), edge))), Object.assign(data2, { subject });
...
), layouter$1 = fromPromise(async ({ input: input2, self, signal }) => {
  const {
    subjectId,
    navigateFromNode,
    xyflow: xyflow2,
...
}), xyflowInit = () => machine$4.assign(({ event }) => (assertEvent(event, "xyflow.init"), {
  xyflow: event.instance,
  xystore: event.store
})), updateView$2 = () => machine$4.assign(({ event }) => (assertEvent(event, "update.view"), {
  layouted: event.layouted,
  ...viewToNodesEdge(event.layouted)
})), xyflowUpdateNodeInternals = () => machine$4.createAction(({ context: context2 }) => {
...
}), xyflowFitDiagram = (params) => machine$4.createAction(({ context: context2, event }) => {
...
}), xyflowApplyNodeChanges$1 = () => machine$4.assign(({ context: context2, event }) => (assertEvent(event, "xyflow.applyNodeChanges"), {
  xynodes: applyNodeChanges(event.changes, context2.xynodes)
})), xyflowApplyEdgeChanges$1 = () => machine$4.assign(({ context: context2, event }) => (assertEvent(event, "xyflow.applyEdgeChanges"), {
  xyedges: applyEdgeChanges(event.changes, context2.xyedges)
})), openRelationshipSource = () => machine$4.enqueueActions(({ system, event }) => {
...
}), dispose$1 = () => machine$4.assign({
  xyflow: null,
  layouted: null,
  xystore: null,
  xyedges: [],
  xynodes: []
}), _relationshipsBrowserLogic = machine$4.createMachine({
...
const ViewPadding = {
...
}), emitOpened = (overlay2) => machine$3.emit({
  type: "opened",
  overlay: overlay2.split("-")[0]
}), emitClosed = (overlay2) => machine$3.emit({
  type: "closed",
  overlay: overlay2.split("-")[0]
}), emitIdle = () => machine$3.emit({ type: "idle" }), closeLastOverlay = () => machine$3.enqueueActions(({ context: context2, enqueue }) => {
...
}), closeSpecificOverlay = () => machine$3.enqueueActions(({ context: context2, enqueue, event }) => {
...
}), closeAllOverlays$1 = () => machine$3.enqueueActions(({ context: context2, enqueue }) => {
  for (const { id } of t$j(context2.overlays))
    enqueue.sendTo(id, { type: "close" }), enqueue.stopChild(id), enqueue(emitClosed(id));
  enqueue.assign({ overlays: [] });
}), openElementDetails$1 = () => machine$3.enqueueActions(({ context: context2, enqueue, event }) => {
...
}), openRelationshipDetails = () => machine$3.enqueueActions(({ context: context2, enqueue, event }) => {
...
}), openRelationshipsBrowser = () => machine$3.enqueueActions(({ context: context2, enqueue, event }) => {
...
}), openOverlay$1 = () => machine$3.enqueueActions(({ enqueue, event }) => {
...
}), listenToEsc = () => machine$3.spawnChild("hotkey", {
  id: "hotkey"
}), stopListeningToEsc = () => machine$3.stopChild("hotkey"), checkState = () => machine$3.enqueueActions(({ enqueue, context: context2 }) => {
  context2.overlays.length === 0 && enqueue.raise({ type: "close" });
}), _overlaysActorLogic = machine$3.createMachine({
  id: "overlays",
  context: () => ({
    seq: 1,
    overlays: []
  ...
  actions: {
    ...
    "assign navigateTo": assign(({ event }) => (assertEvent(event, ["navigate.to"]), {
      navigateTo: {
        viewId: event.viewId,
    ...
    waitAnimationEnd: {
      on: {
        "animation.presence.end": {
          target: "inactive",
          actions: enqueueActions(({ context: context2, system, enqueue }) => {
            const navigateTo = context2.navigateTo;
            if (!navigateTo) return;
            enqueue("reset navigateTo");
            const diagramActor = typedSystem(system).diagramActorRef;
            if (navigateTo.focusOnElement && diagramActor.getSnapshot().context.view.id === navigateTo.viewId) {
              enqueue.sendTo(diagramActor, {
                type: "focus.node",
  ...
  const hasActiveWalkthrough = e$8(context2.activeWalkthrough), enableCompareWithLatest = context2.features.enableCompareWithLatest && (toggledFeatures.enableCompareWithLatest ?? !1) && e$8(context2.view._layout) && !hasActiveWalkthrough, enableReadOnly = context2.features.enableReadOnly || (toggledFeatures.enableReadOnly ?? !1) || hasActiveWalkthrough || enableCompareWithLatest && context2.view._layout === "auto";
  return {
    enableCompareWithLatest,
    enableReadOnly
  };
}, isReadOnly = (context2) => deriveToggledFeatures(context2).enableReadOnly, machine$2 = setup({
  actors: {
    hotkeyActorLogic,
    overlaysActorLogic,
    searchActorLogic,
  ...
  guards: {
    ...
    "click: active walkthrough step": ({ context: context2, event }) => {
      if (assertEvent(event, ["xyflow.edgeClick", "xyflow.edgeDoubleClick"]), !context2.activeWalkthrough)
        return !1;
      const { stepId } = context2.activeWalkthrough;
...
}, to$2 = t$k(targetState, (id) => ({ target: id })), selectCompareLayoutState = ({ context: context2 }) => {
...
const createRecipe = (name, defaultVariants, compoundVariants) => {
  const getVariantProps2 = (variants2) => ({
    [name]: "__ignore__",
    ...defaultVariants,
    ...compact(variants2)
  });
  return {
    recipeFn: (variants2, withCompoundVariants = !0) => {
      const recipeCss = createCss({
        ...
        utility: {
          toHash: (path, hashFn) => hashFn(path.join(":")),
          transform: (prop, value) => (assertCompoundVariant(name, compoundVariants, variants2, prop), value === "__ignore__" ? { className: name } : (value = withoutSpace(value), { className: `${name}--${prop}_${value}` }))
        }
      }), recipeStyles = getVariantProps2(variants2);
    ...
    getVariantProps: getVariantProps2,
    __getCompoundVariantCss__: (variants2) => getCompoundVariantCss(compoundVariants, getVariantProps2(variants2))
  };
...
}), actionButtonsFn = /* @__PURE__ */ createRecipe("action-buttons", {}, []), actionButtonsVariantMap = {}, actionButtonsVariantKeys = Object.keys(actionButtonsVariantMap), actionButtons = /* @__PURE__ */ Object.assign(memo(actionButtonsFn.recipeFn), {
  __recipe__: !0,
...
}), compoundNodeFn = /* @__PURE__ */ createRecipe("likec4-compound-node", {
  isTransparent: !1,
  inverseColor: !1,
  borderStyle: "none"
}, []), compoundNodeVariantMap = {
  isTransparent: [
    "false",
    "true"
  ],
...
}), elementNodeDataFn = /* @__PURE__ */ createRecipe("likec4-element-node-data", {
  iconPosition: "left",
  withIconColor: !1
}, []), elementNodeDataVariantMap = {
  iconPosition: [
    "left",
    "right",
    "top",
...
}, elementNodeDataVariantKeys = Object.keys(elementNodeDataVariantMap), elementNodeData = /* @__PURE__ */ Object.assign(memo(elementNodeDataFn.recipeFn), {
  __recipe__: !0,
...
}), nodeNotesFn = /* @__PURE__ */ createRecipe("likec4-node-notes", {
  opened: !1
}, []), nodeNotesVariantMap = {
  opened: [
    "false",
...
}, nodeNotesVariantKeys = Object.keys(nodeNotesVariantMap), nodeNotes = /* @__PURE__ */ Object.assign(memo(nodeNotesFn.recipeFn), {
  __recipe__: !0,
  __name__: "nodeNotes",
  ...
  "truncateLabel"
], getVariantProps$1 = (variants2) => ({ ...navigationLinkDefaultVariants, ...compact(variants2) }), navigationLink = /* @__PURE__ */ Object.assign(navigationLinkFn, {
  __recipe__: !1,
  ...
  "size",
  "panelPosition"
], getVariantProps = (variants2) => ({ ...navigationPanelDefaultVariants, ...compact(variants2) }), navigationPanel = /* @__PURE__ */ Object.assign(navigationPanelFn, {
  __recipe__: !1,
...
const hasDrifts$1 = (item) => !!item.drifts && t$1(item.drifts, 1), selectDrifts = selectDiagramActorContext((ctx) => ({
  ...
  exit: {
    ...
    translateY: -8,
    transition: {
      delayChildren: stagger(0.2, { startDelay: 0.5, from: "last" })
    }
  }
};
function DriftsSummary() {
  const selected = useDiagramSnapshot(selectDrifts, deepEqual), diagram = useDiagram(), onMouseLeaveDebounced = useDebouncedCallback(
    (e2) => {
      e2.stopPropagation(), diagram.unhighlightAll();
    },
    150
  ), onMouseEnter = useCallbackRef((e2) => {
    const target = e2.currentTarget.getAttribute("data-drift-type"), id = e2.currentTarget.getAttribute("data-drift-id");
    if (target === "node" && id) {
      e2.stopPropagation(), onMouseLeaveDebounced.cancel(), diagram.highlightNode(id);
      return;
    }
    if (target === "edge" && id) {
      e2.stopPropagation(), onMouseLeaveDebounced.cancel(), diagram.highlightEdge(id);
      return;
    }
  }), onClick = useCallbackRef((e2) => {
    const target = e2.currentTarget.getAttribute("data-drift-type"), id = e2.currentTarget.getAttribute("data-drift-id");
    if (target === "node" && id) {
      e2.stopPropagation(), diagram.centerViewportOnNode(id);
      return;
    }
    if (target === "edge" && id) {
      e2.stopPropagation(), diagram.centerViewportOnEdge(id);
      return;
    }
  }), handlers = {
    onMouseEnter,
...
function ViewDrifts({ drifts }) {
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(
    m$1.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsx(SectionHeader$2, { children: "View drifts (summary):" }),
        /* @__PURE__ */ jsx(DriftsGroup, { children: t$a(drifts, (drift) => /* @__PURE__ */ jsx(DriftLabel, { children: drift }, drift)) }, "view-drifts")
      ]
    },
    "view-drifts-header"
  ) });
...
const DriftsGroup = styled(m$1.div, {
...
}), SectionHeader$2 = styled(m$1.div, {
  base: {
    userSelect: "none",
    fontWeight: "medium",
    textStyle: "dimmed.xs",
  ...
  const portalProps = useMantinePortalProps(), isMounted = useIsMounted(), { enableCompareWithLatest } = useEnabledFeatures(), [ctx, ops] = useDiagramCompareLayout(), [isProcessing, setIsProcessing] = useState(!1), resetProcessing = () => {
    setTimeout(() => {
      isMounted() && setIsProcessing(!1);
    }, 500);
  }, onApplyLatest = useCallbackRef((e2) => {
    ...
    e2.stopPropagation(), setIsProcessing(!0), setTimeout(() => {
      ops.applyLatestToManual(), resetProcessing();
    }, 200);
  }), onResetManualLayout = useCallbackRef((e2) => {
    e2.stopPropagation(), setIsProcessing(!0), setTimeout(() => {
      ops.resetManualLayout(), resetProcessing();
    }, 200);
  });
  return /* @__PURE__ */ jsx(AnimatePresence, { children: enableCompareWithLatest && /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(
      MotionDiv,
      {
        layout: "size",
    ...
    /* @__PURE__ */ jsxs(
      MotionDiv,
      {
        ...
        children: [
          /* @__PURE__ */ jsx(DriftsSummary, {}),
          ctx.canApplyLatest && /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(MotionDiv, { layout: "position", className: css({ flex: "0" }), children: [
            /* @__PURE__ */ jsx(Divider$2, { orientation: "horizontal", size: "xs", mb: "xs" }),
...
const Tooltip$5 = Tooltip$7.withProps({
  color: "dark",
  fz: "xs",
  openDelay: 600,
  closeDelay: 120,
  ...
  return /* @__PURE__ */ jsx(Tooltip$5, { label: "Center camera", children: /* @__PURE__ */ jsx(PanelActionIcon, { onClick: () => diagram.fitDiagram(), children: /* @__PURE__ */ jsx(IconFocusCentered, {}) }) });
};
css({
  gap: "xxs",
  _empty: {
...
const autolayoutButton = css({
  ...
  return isManualLayout ? null : /* @__PURE__ */ jsxs(
    Popover,
    {
      ...
      children: [
        /* @__PURE__ */ jsx(PopoverTarget, { children: /* @__PURE__ */ jsx(Tooltip$5, { label: "Change Auto Layout", children: /* @__PURE__ */ jsx(PanelActionIcon, { children: /* @__PURE__ */ jsx(IconLayoutDashboard, {}) }) }) }),
        /* @__PURE__ */ jsx(PopoverDropdown, { className: "likec4-top-left-panel", p: 8, pt: 6, opacity: isSpacingHovered ? 0.6 : 1, children: /* @__PURE__ */ jsxs(Box$1, { pos: "relative", ref: setRootRef, children: [
          ...
          /* @__PURE__ */ jsxs(Flex$1, { gap: 2, wrap: "wrap", justify: "stretch", maw: 160, children: [
  ...
  icon: icon2,
  onClick
}) => /* @__PURE__ */ jsx(Tooltip$5, { label: label2, withinPortal: !1, position: "top", children: /* @__PURE__ */ jsx(
  PanelActionIcon,
  {
    classNames: {
      root: "action-icon",
  ...
  return /* @__PURE__ */ jsxs(
    Popover,
    {
      ...
      ...portalProps,
      children: [
        /* @__PURE__ */ jsx(PopoverTarget, { children: /* @__PURE__ */ jsx(Tooltip$5, { label: "Manual layouting tools", children: /* @__PURE__ */ jsx(PanelActionIcon, { children: /* @__PURE__ */ jsx(IconLayoutCollage, {}) }) }) }),
        /* @__PURE__ */ jsx(
          PopoverDropdown,
          {
            className: hstack({
...
const ToggleReadonly$1 = () => {
  const diagram = useDiagram();
  return /* @__PURE__ */ jsx(Tooltip$5, { label: "Switch to Read-only", children: /* @__PURE__ */ jsx(PanelActionIcon, { onClick: () => diagram.toggleFeature("ReadOnly"), children: /* @__PURE__ */ jsx(IconLockOpen2, { size: 14, stroke: 2 }) }) });
};
function EditorPanel$1() {
...
const NavigationPanelActorSafeContext = createContext$1(null);
...
function CompoundActionButton({
  ...
  return /* @__PURE__ */ jsx(
    MotionDiv,
    {
      initial: !1,
      variants: variants$5,
      animate: isHoverDebounced ? "hovered" : "normal",
...
function CompoundNodeContainer({
  ...
  let opacity = t(data2.style.opacity ?? 100, {
    min: 0,
    max: 100
  });
  const isTransparent = opacity < 98, MIN_OPACITY = 50, borderOpacity = MIN_OPACITY + t((100 - MIN_OPACITY) * (opacity / 100), {
    min: 0,
    max: 100 - MIN_OPACITY
  }), compoundClass = compoundNode({
    isTransparent,
    inverseColor: opacity < 70,
    borderStyle: data2.style.border ?? (isTransparent ? styles.defaults.group.border : "none")
  }), depth = t(data2.depth ?? 1, {
    min: 1,
...
function CompoundTitle({ data: data2 }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "likec4-compound-title-container", children: [
    elementIcon2,
    /* @__PURE__ */ jsx("div", { className: "likec4-compound-title", children: data2.title })
  ] });
}
...
function EdgeContainer({
  ...
  const props = {
    ...
    "data-edge-dir": data2.dir ?? "forward",
...
const EdgeLabel = forwardRef(({
  ...
  const stepNum = isStepEdgeId(id) ? extractStep(id) : null, isStepEdge = stepNum !== null, hasLabel = e$8(label2) || e$8(technology);
  return /* @__PURE__ */ jsxs(
    MotionDiv,
    {
      ref,
...
const toCssVarValue = (value) => value === void 0 ? "" : e$9(value) ? `${Math.trunc(value)}px` : value;
function EdgeLabelContainer({
  ...
  return animated = animated || isActive, /* @__PURE__ */ jsx(EdgeLabelRenderer, { children: /* @__PURE__ */ jsx(
    "div",
    {
      ...rest,
      className: cx(
...
function ElementActionButtons({
  ...
  return /* @__PURE__ */ jsx("div", { className: actionButtons(), children: /* @__PURE__ */ jsx(
    MotionDiv,
    {
      layoutRoot: !0,
      initial: !1,
...
const resolveIconColor = (styles, data2) => {
  const iconColor2 = data2.style.iconColor;
  if (!iconColor2)
    return;
  const colors = styles.colors(iconColor2).elements;
  return iconColor2 === data2.color ? colors.stroke : colors.fill;
}, Root$2 = forwardRef(({
  className,
  style,
  data: data2,
  ...
  const styles = useLikeC4Styles(), iconSize2 = data2.style.iconSize ? styles.nodeSizes(data2.style).values.iconSize : void 0, resolvedIconColor = resolveIconColor(styles, data2);
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...props,
      ...
      className: cx(
        className,
        elementNodeData({
          iconPosition: data2.style.iconPosition,
...
}), Icon$1 = ({ data: data2, ...props }) => /* @__PURE__ */ jsx(IconRenderer, { element: data2, ...props }), Content$1 = forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx(
  "div",
  {
    ...props,
    className: cx(
...
)), Title = forwardRef(({ data: { title: title2 }, className, ...props }, ref) => /* @__PURE__ */ jsx(
  "div",
  {
    ...props,
    className: cx(
...
)), Technology = forwardRef(({ data: data2, children, className, ...props }, ref) => {
  const text = data2?.technology ?? children;
...
}), Description = forwardRef(({ data: { description: description2 }, className, ...props }, ref) => {
  if (!description2)
    return null;
  const desc = RichText.from(description2);
  return /* @__PURE__ */ jsx(
    Markdown,
    {
      ...props,
...
function ElementData({ data: data2 }) {
  return /* @__PURE__ */ jsxs(Root$2, { data: data2, children: [
    /* @__PURE__ */ jsx(Icon$1, { data: data2 }),
    /* @__PURE__ */ jsxs(Content$1, { children: [
      /* @__PURE__ */ jsx(Title, { data: data2 }),
      /* @__PURE__ */ jsx(Technology, { data: data2 }),
      /* @__PURE__ */ jsx(Description, { data: data2 })
    ] })
  ] });
}
ElementData.Root = Root$2;
ElementData.Icon = Icon$1;
ElementData.Content = Content$1;
...
const PersonIcon = {
...
}, ComponentTopLeftRect = ({ index: index2, size: size2 }) => {
  let width, height, offsetX, offsetY, between;
  switch (size2) {
    case "xs":
    case "sm": {
      width = 40, height = 18, offsetX = -16, offsetY = 16, between = 10;
      break;
    }
    case "md": {
      width = 60, height = 26, offsetX = -20, offsetY = 22, between = 14;
      break;
    }
    case "lg":
    case "xl": {
      width = 70, height = 32, offsetX = -24, offsetY = 32, between = 18;
      break;
    }
    default:
      nonexhaustive(size2);
  ...
  return /* @__PURE__ */ jsx(
    ...
    {
      x: offsetX,
      y: offsetY + (height + between) * index2,
      width,
      height,
      rx: 3,
...
function ShapeSvg({ shape, w, h, size: size2 = "md" }) {
  switch (shape) {
    case "component":
      return /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(
        ...
        /* @__PURE__ */ jsx(ComponentTopLeftRect, { index: 0, size: size2 }),
        /* @__PURE__ */ jsx(ComponentTopLeftRect, { index: 1, size: size2 })
      ] });
    case "mobile":
      return /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(
...
function ElementShape({ data: data2, width, height, showSelectionOutline = !0 }) {
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "likec4-shape-outline" })
        ]
      }
    );
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("svg", { className, viewBox: `0 0 ${w} ${h}`, children: [
      /* @__PURE__ */ jsx(ShapeSvgOutline, { shape: data2.shape, w, h }),
      /* @__PURE__ */ jsx(ShapeSvg, { shape: data2.shape, size: data2.style?.size, w, h })
    ] })
  ] });
}
...
), propsAreEqual = (prev, next) => prev.id === next.id && prev.data.width === next.data.width && (prev.data.hovered ?? !1) === (next.data.hovered ?? !1) && deepEqual(prev.data.tags, next.data.tags), ElementTags$4 = memo$1(
  ({ id, data: { tags, width, hovered = !1 }, onTagClick, onTagMouseEnter, onTagMouseLeave }) => !tags || !t$1(tags, 1) ? null : /* @__PURE__ */ jsx(
    WithElementTags,
    {
      id,
      tags,
...
ElementTags$4.displayName = "ElementTags";
function WithElementTags({
  ...
  const zoomIsLargeEnough = useCurrentZoomAtLeast(1.2), maxWidth = useStore(
    useCallback(
      ...
      HStack,
      {
        ...
        children: tags.map((tag) => /* @__PURE__ */ jsx(
          ElementTag,
          {
            ...
            onClick: onTagClick ? ((e2) => {
              e2.stopPropagation(), onTagClick(`#${tag}`);
            }) : void 0,
            onMouseEnter: onTagMouseEnter ? () => onTagMouseEnter(`#${tag}`) : void 0,
            onMouseLeave: onTagMouseLeave ? () => onTagMouseLeave(`#${tag}`) : void 0
          },
          tag
        ))
      }
...
const isSame = (a, b) => Math.abs(a - b) < 2.5, edgePropsEqual = (prev, next) => prev.id === next.id && deepEqual(prev.selected ?? !1, next.selected ?? !1) && deepEqual(prev.animated ?? !1, next.animated ?? !1) && deepEqual(prev.source, next.source) && deepEqual(prev.target, next.target) && isSame(prev.sourceX, next.sourceX) && isSame(prev.sourceY, next.sourceY) && isSame(prev.targetX, next.targetX) && isSame(prev.targetY, next.targetY) && deepEqual(prev.sourceHandleId ?? null, next.sourceHandleId ?? null) && deepEqual(prev.targetHandleId ?? null, next.targetHandleId ?? null) && deepEqual(prev.sourcePosition, next.sourcePosition) && deepEqual(prev.targetPosition, next.targetPosition) && deepEqual(prev.data, next.data);
...
function nodePropsEqual(prev, next) {
  return prev.id === next.id && deepEqual(prev.type, next.type) && deepEqual(prev.parentId ?? "", next.parentId ?? "") && deepEqual(prev.selected ?? !1, next.selected ?? !1) && deepEqual(prev.dragging ?? !1, next.dragging ?? !1) && deepEqual(prev.width ?? 0, next.width ?? 0) && deepEqual(prev.height ?? 0, next.height ?? 0) && deepEqual(prev.zIndex ?? 0, next.zIndex ?? 0) && deepEqual(prev.data, next.data);
}
...
function DefaultHandles({ direction = "TB" }) {
...
const GithubIcon = forwardRef((props, ref) => /* @__PURE__ */ jsx(
  ...
  const [opened, setOpened] = useState(!1), data2 = useNavigationActorSnapshot(selector$6, deepEqual), portalProps = useMantinePortalProps();
  return /* @__PURE__ */ jsxs(
    Popover,
    {
      position: "bottom-end",
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx(ViewDetailsCardTrigger, { linksCount: data2.links.length, onOpen: () => setOpened(!0) }),
        opened && /* @__PURE__ */ jsx(ViewDetailsCardDropdown, { data: data2, onClose: () => setOpened(!1) })
      ]
    }
  );
...
const Logo$1 = forwardRef(
  ...
  return enableVscode ? /* @__PURE__ */ jsx(Tooltip$6, { label: "Open View Source", children: /* @__PURE__ */ jsx(
    PanelActionIcon,
    {
      onClick: (e2) => {
...
const selector$5 = (ctx) => {
  const comparingLatest = deriveToggledFeatures(ctx).enableCompareWithLatest && !!ctx.view.drifts && ctx.view._layout === "auto", noActiveWalkthrough = !e$8(ctx.activeWalkthrough);
  return {
...
}), TriggerWalkthroughButton = forwardRef((props, ref) => /* @__PURE__ */ jsx(
  Button,
  {
    variant: "filled",
    size: "xs",
...
const ProjectsMenu = memo$1((_) => {
  const { projects, onProjectChange: onProjectChange2 } = useLikeC4ProjectsContext();
  return projects.length <= 1 ? null : /* @__PURE__ */ jsx(WithProjectsMenu, { projects, onProjectChange: onProjectChange2 });
});
function WithProjectsMenu({
  projects,
  onProjectChange: onProjectChange2
}) {
  const projectId = useLikeC4ProjectId();
  return /* @__PURE__ */ jsxs(HStack, { gap: "0.5", alignItems: "baseline", children: [
    /* @__PURE__ */ jsx(
      Box,
      {
        css: {
  ...
  return useEffect(() => {
    setFound((current) => {
      const results = t$6(
        ...
        ifirst(20),
        toArray(),
        t$l((a, b) => compare(a.folder.path, b.folder.path))
      );
...
function FoundedView({ view, highlight, ...props }) {
  ...
  return breadcrumbs.push(
    ...
    UnstyledButton,
    {
      ...
      children: [
        folderIcon,
        /* @__PURE__ */ jsx(Breadcrumbs, { separator: btnRightSection, separatorMargin: 3, children: breadcrumbs })
      ]
    }
  );
}
...
function FolderColumn({ data: data2, isLast }) {
  ...
  }), /* @__PURE__ */ jsx(Box, { mb: "1", ref, children: /* @__PURE__ */ jsx(ColumnScrollArea, { children: /* @__PURE__ */ jsx(VStack, { gap: "0.5", children: data2.items.map((item, i) => /* @__PURE__ */ jsx(
    FolderColumnItem,
    {
      columnItem: item,
      onClick: onItemClicked(item)
    },
    `${data2.folderPath}/${item.type}/${i}`
  )) }) }) });
}
...
const WalkthroughPanel = memo$1(() => {
  ...
  }, [actorRef, viewModel, view]), /* @__PURE__ */ jsx(
    VStack,
    {
      css: {
      ...
      children: /* @__PURE__ */ jsxs(NavigationPanelActorContextProvider, { value: actorRef, children: [
        ...
        /* @__PURE__ */ jsx(EditorPanel$1, {})
      ] })
    }
  );
});
NavigationPanel$1.displayName = "NavigationPanel";
const stateHasActiveTag = (state) => state.hasTag("active"), NavigationPanelImpl = ({ actor }) => {
  const opened = useSelector(actor, stateHasActiveTag), portalProps = useMantinePortalProps();
  return /* @__PURE__ */ jsxs(
    Popover,
    {
      offset: {
...
}, ElementDetailsActorContext = createContext$1(null);
...
function MultiValueDisplay({
  ...
  return isExpanded ? /* @__PURE__ */ jsx(Stack, { gap: "xs", children: values.map((value, index2) => /* @__PURE__ */ jsxs(Flex$1, { align: "center", gap: "xs", children: [
    /* @__PURE__ */ jsx(
      Text,
      {
        className: css({
    ...
    Box$1,
    {
      ...
      children: values.map((value, index2) => /* @__PURE__ */ jsxs(Flex$1, { align: "center", gap: "xs", style: { minWidth: 0 }, children: [
        /* @__PURE__ */ jsx(
          Text,
          {
            className: css({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    hasMultipleElements ? /* @__PURE__ */ jsx(
      UnstyledButton,
      {
        ...
        children: /* @__PURE__ */ jsxs(Flex$1, { align: "center", gap: "xs", children: [
...
const treeNode$1 = css({
...
] }), zoomIcon = /* @__PURE__ */ jsx(ThemeIcon, { size: "sm", variant: "transparent", color: "gray", children: /* @__PURE__ */ jsx(IconZoomScan, { stroke: 1.8, opacity: 0.65 }) }), DeployedInstanceRenderer = ({
  instance
}) => {
...
}, infoIcon$1 = /* @__PURE__ */ jsx(IconInfoCircle, {}), setHoveredNode$3 = () => {
}, TabPanelDeployments = memo$1(({ elementFqn }) => {
  const element = useLikeC4Model().element(elementFqn), deployments = [...element.deployments()], tree2 = useTree({
    multiple: !1
  });
  tree2.setHoveredNode = setHoveredNode$3;
  const data2 = useMemo(() => {
  ...
  }, [data2]), deployments.length === 0 ? /* @__PURE__ */ jsx(Alert, { variant: "light", color: "gray", icon: infoIcon$1, children: "This element does not have any deployments" }) : (
    // <Box></Box>
    /* @__PURE__ */ jsx(
      Tree$1,
      {
...
}), RelationshipsBrowserActorContext = createContext$1(null);
...
function EmptyNode({
  ...
  return /* @__PURE__ */ jsx(
    Box,
    {
      ...
      children: /* @__PURE__ */ jsxs(Text, { c: "dimmed", fz: "lg", fw: 500, children: [
        "No ",
...
function ElementNode$2(props) {
  ...
  return /* @__PURE__ */ jsxs(ElementNodeContainer, { layoutId: props.id, nodeProps: props, children: [
    ...
    enableElementTags && /* @__PURE__ */ jsx(ElementTags$3, { ...props }),
...
const ElementPorts$1 = ({ data: { ports, height: h } }) => /* @__PURE__ */ jsxs(Fragment, { children: [
...
] }), CompoundPorts$1 = ({ data: data2 }) => /* @__PURE__ */ jsxs(Fragment, { children: [
  data2.ports.in.map((id, i) => /* @__PURE__ */ jsx(
    Handle,
    {
      id,
      type: "target",
  ...
  data2.ports.out.map((id, i) => /* @__PURE__ */ jsx(
    Handle,
    {
      id,
      type: "source",
...
function useLikeC4ElementsTree(viewId) {
  const model = useLikeC4Model();
  return useMemo(() => viewId ? [...model.view(viewId).roots()].map(buildNode).sort(sortByLabel) : [...model.roots()].map(buildNode).sort(sortByLabel), [model, viewId]);
}
const node = css({
  margin: "0"
}), label = css({
                ...
                renderNode: ({ node: node2, selected, expanded, elementProps, hasChildren }) => /* @__PURE__ */ jsxs(Group, { gap: 2, wrap: "nowrap", ...elementProps, py: "3", children: [
                  ...
                  /* @__PURE__ */ jsx(
                    Box$1,
                    {
                      ...
                      w: "100%",
                      onClick: (e2) => {
                        e2.stopPropagation(), tree2.select(node2.value), tree2.expand(node2.value), browser.navigateTo(node2.value);
                      },
                      children: /* @__PURE__ */ jsx(
                        Text,
                        {
...
const selector$4 = (state) => ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    closeable && /* @__PURE__ */ jsx(Panel, { position: "top-right", children: /* @__PURE__ */ jsxs(Group, { gap: 4, wrap: "nowrap", children: [
      /* @__PURE__ */ jsx(CopyLinkButton, { subjectId }),
      /* @__PURE__ */ jsx(
        ActionIcon,
        {
          variant: "default",
...
function buildRelationshipUrl(subjectId) {
  ...
  return currentUrl.searchParams.set("relationships", subjectId), currentUrl.href;
}
const CopyLinkButton = ({ subjectId }) => {
  const clipboard = useClipboard({ timeout: 2e3 }), [copyError, setCopyError] = useState(!1), errorTimeoutRef = useRef(null), handleCopy = async (e2) => {
    e2.stopPropagation(), setCopyError(!1), errorTimeoutRef.current && (clearTimeout(errorTimeoutRef.current), errorTimeoutRef.current = null);
    const url = buildRelationshipUrl(subjectId);
    if (!window.isSecureContext) {
      setCopyError(!0), errorTimeoutRef.current = window.setTimeout(() => {
        setCopyError(!1);
      }, 2e3);
      return;
    }
  ...
  useEffect(() => {
    clipboard.error && (setCopyError(!0), errorTimeoutRef.current && clearTimeout(errorTimeoutRef.current), errorTimeoutRef.current = window.setTimeout(() => {
      setCopyError(!1);
    }, 2e3));
  }, [clipboard.error]), useEffect(() => () => {
    errorTimeoutRef.current && clearTimeout(errorTimeoutRef.current);
  }, []);
  const buttonState = clipboard.copied ? {
  ...
  return /* @__PURE__ */ jsx(Tooltip$4, { label: buttonState.tooltip, withArrow: !0, position: "top", withinPortal: !1, children: /* @__PURE__ */ jsx(
    ActionIcon,
    {
      variant: "default",
      color: "gray",
...
const Tooltip$3 = Tooltip$7.withProps({
  color: "dark",
  fz: "xs",
  openDelay: 600,
  closeDelay: 120,
...
function TabPanelRelationships({
  ...
  return /* @__PURE__ */ jsxs(Stack, { gap: "xs", pos: "relative", w: "100%", h: "100%", children: [
    incoming.length + outgoing.length > 0 && /* @__PURE__ */ jsxs(Group, { gap: "xs", wrap: "nowrap", align: "center", children: [
      ...
      notIncludedRelations > 0 && /* @__PURE__ */ jsx(Tooltip$3, { label: "Current view does not include some relationships", children: /* @__PURE__ */ jsxs(
        Group,
        {
          mt: "xs",
          gap: 6,
...
const treeNodeLabel = css({
  ...
  element
}) => /* @__PURE__ */ jsx(Box$1, { className: elementLabel, children: /* @__PURE__ */ jsx(Text, { component: "div", fz: "sm", fw: "500", children: element.title }) }), infoIcon = /* @__PURE__ */ jsx(IconInfoCircle, {}), setHoveredNode$1 = () => {
};
function TabPanelStructure({
  ...
  tree2.setHoveredNode = setHoveredNode$1;
  const data2 = useMemo(() => {
    let seq = 1;
  ...
  return useEffect(() => {
    ...
    /* @__PURE__ */ jsxs(Alert, { variant: "light", color: "orange", title: "In development", icon: infoIcon, children: [
...
function ElementDetailsCard({
  ...
  const [opened, setOpened] = useState(!1), windowSize = useViewportSize(), windowWidth = windowSize.width || window.innerWidth || 1200, windowHeight = windowSize.height || window.innerHeight || 800, [activeTab, setActiveTab] = useSessionStorage({
    ...
    [...elementModel.views()],
    t$a((v) => v.$view),
    t$m((v) => v._type === "element" && v.viewOf === fqn2)
  );
  ...
  }, [width, height]), ref = useRef(null), close = useDebouncedCallback$1(
    useCallbackRef(onClose),
    [],
    50
  ), triggerClose = useCallbackRef((event) => {
                ...
                /* @__PURE__ */ jsxs(
                  ActionIconGroup,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsx(IfEnabled, { feature: "Vscode", children: /* @__PURE__ */ jsx(Tooltip$2, { label: "Open source", children: /* @__PURE__ */ jsx(
                        ActionIcon,
                        {
                          size: "lg",
                          variant: "default",
                      ...
                      defaultView && /* @__PURE__ */ jsx(Tooltip$2, { label: "Open default view", children: /* @__PURE__ */ jsx(
                        ActionIcon,
                        {
                          size: "lg",
                          variant: "default",
...
function ElementTags$2({ tags, onClick }) {
  return /* @__PURE__ */ jsxs(Flex$1, { gap: 4, flex: 1, mt: 6, wrap: "wrap", children: [
    tags.map((tag) => /* @__PURE__ */ jsx(
      ElementTag,
      {
        ...
        cursor: "pointer",
        onClick: (e2) => {
          e2.stopPropagation(), onClick(tag);
        }
      },
      tag
    )),
    tags.length === 0 && /* @__PURE__ */ jsx(Badge, { radius: "sm", size: "sm", fw: 600, color: "gray", children: "—" })
  ] });
}
const selector$3 = (s) => ({
...
const ElementDetailsButtonWithHandler$1 = (props) => {
  ...
  return /* @__PURE__ */ jsxs(ElementNodeContainer, { nodeProps: props, children: [
    /* @__PURE__ */ jsx(ElementShape, { ...props }),
    /* @__PURE__ */ jsx(ElementData, { ...props }),
    enableElementTags && /* @__PURE__ */ jsx(ElementTags$1, { ...props }),
...
] }), CompoundPorts = ({ data: data2 }) => /* @__PURE__ */ jsxs(Fragment, { children: [
  data2.ports.in.map((id, i) => /* @__PURE__ */ jsx(
    Handle,
    {
      id,
...
] }), RelationshipDetailsActorContext = createContext$1(null);
...
function createNodes(column, elements, g) {
  ...
  for (const element of tree2.sorted) {
    const isCompound = tree2.children(element).length > 0, fqn2 = element.id, id = `${column}-${fqn2}`, portId = isCompound ? `${id}${PortSuffix}` : id;
    graphNodes.set(fqn2, {
      id,
      portId
    }), g.setNode(id, {
...
function layoutRelationshipDetails(data2, scope) {
  const g = createGraph(), sources = createNodes("sources", data2.sources, g), targets = createNodes("targets", data2.targets, g), edges = Array.from(data2.relationships).map((r2) => {
...
const selectSubject = (state) => ({
  ...
  const actor = useRelationshipDetailsActor(), subject = useSelector(actor, selectSubject, deepEqual), likec4model = useLikeC4Model(), view = likec4model.findView(subject.viewId) ?? null, data2 = useMemo(() => {
    let data22;
    if ("edgeId" in subject && e$8(subject.edgeId)) {
      ...
      data22 = computeEdgeDetailsViewData([edge.id], view);
    } else if (subject.source && subject.target)
      data22 = computeRelationshipDetailsViewData({
        source: likec4model.element(subject.source),
        target: likec4model.element(subject.target)
      });
    else
      return null;
    return layoutRelationshipDetails(data22, view);
  }, [
    subject,
    view,
    likec4model
  ...
  return useEffect(() => {
    ...
    data2 !== null && actor.send({ type: "update.layoutData", data: data2 });
  }, [data2, actor]), null;
...
const select$1 = (s) => s.children.search ?? null;
...
const NothingFound = () => /* @__PURE__ */ jsx(Box, { className: emptyBoX, children: "Nothing found" }), useFoundViews = () => {
  ...
  const ref = useRef(null), [views, search, currentViewId] = useFoundViews();
  return /* @__PURE__ */ jsxs(
    Stack,
    {
      ref,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs(Box, { style: { flexGrow: 1 }, children: [
          /* @__PURE__ */ jsxs(Group, { gap: "xs", wrap: "nowrap", align: "center", children: [
            /* @__PURE__ */ jsx(Highlight, { component: "div", highlight: search, className: btn$1.title, children: view.titleOrUntitled }),
...
function useElementsColumnData() {
  const model = useLikeC4Model(), allElements = useMemo(() => t$6(
    model.elements(),
    ...
    toArray()
  ), [model]), search = useNormalizedSearch();
  return useMemo(() => {
    ...
    if (search === "" || search === "kind:")
      ...
      elements = n$2(allElements, ({ element }) => element.kind.toLocaleLowerCase()[searchKind.length > 4 ? "startsWith" : "includes"](searchKind));
    } else if (search.startsWith("#")) {
      const searchTag = search.slice(1);
      elements = n$2(allElements, ({ element }) => element.tags.some((tag) => tag.toLocaleLowerCase().includes(searchTag)));
    } else if (t$1(searchTerms, 2)) {
      const satisfies = (element) => {
        ...
        for (let i = 0; i < fqnParts.length; i++)
          if (fqnParts[i].includes(searchTerms[lastMatchIndex])) {
            if (lastMatchIndex++, lastMatchIndex === searchTerms.length)
              return !0;
            continue;
          }
        return !1;
      };
      elements = n$2(allElements, ({ element }) => satisfies(element));
    } else
      elements = n$2(allElements, ({ element }) => (element.title + " " + element.name + " " + (element.summary.md || "")).toLocaleLowerCase().includes(search));
    const byid = {}, { hash, all, roots } = t$6(
      elements,
      t$g((acc, treeItem) => {
    ...
    return {
      ...
      byid,
      roots,
      searchTerms: t$1(searchTerms, 1) ? searchTerms : [search]
    };
  }, [allElements, search]);
}
const btn = buttonsva(), ElementsColumn = memo$1(() => {
  const data2 = useElementsColumnData(), handleClick2 = useHandleElementSelection();
  return data2.all.length === 0 ? /* @__PURE__ */ jsx(NothingFound, {}) : /* @__PURE__ */ jsx(ElementsTree$1, { data: data2, handleClick: handleClick2 });
}), setHoveredNode = () => {
};
function ElementsTree$1({
  data: {
    searchTerms,
    all,
    byid,
  ...
  tree2.setHoveredNode = setHoveredNode, useEffect(() => {
    tree2.collapseAllNodes();
    for (const nd of all)
      nd.children.length > 0 && tree2.expand(nd.value);
  }, [hash]);
  const onKeyDownCapture = useCallbackRef((e2) => {
    ...
    if (node2) {
      ...
      if (e2.key === "ArrowRight") {
        if (node2.children.length > 0 && tree2.expandedState[id] === !1)
          return;
  ...
  return /* @__PURE__ */ jsx(
    Tree$1,
    {
      ...
      onKeyDownCapture,
      renderNode: (p) => /* @__PURE__ */ jsx(ElementTreeNode, { ...p, searchTerms, handleClick: handleClick2 })
    }
  );
}
function ElementTreeNode({ node: node2, elementProps, hasChildren, expanded, handleClick: handleClick2, searchTerms }) {
  const { label: label2, element, viewsCount } = node2, elementIcon$12 = IconOrShapeRenderer({
    element: {
      id: element.id,
      title: element.title,
      shape: element.shape,
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs(Box$1, { style: { flexGrow: 1 }, children: [
            /* @__PURE__ */ jsxs(Group, { gap: "xs", wrap: "nowrap", align: "center", className: elementTitleAndId, children: [
              /* @__PURE__ */ jsx(Highlight, { component: "div", highlight: searchTerms, className: btn.title, children: label2 }),
              /* @__PURE__ */ jsx(Tooltip$7, { label: element.id, withinPortal: !1, fz: "xs", disabled: !element.id.includes("."), children: /* @__PURE__ */ jsx(
                Highlight,
                {
                  component: "div",
                  highlight: t$b(searchTerms),
            ...
            /* @__PURE__ */ jsx(
              Highlight,
              {
                ...
                lineClamp: 1,
                children: element.summary.nonEmpty ? element.summary.text : "No description"
              }
            )
          ] }),
          /* @__PURE__ */ jsx(Txt, { as: "div", className: cx(elementViewsCount, btn.descriptionColor), size: "xs", children: viewsCount === 0 ? "No views" : /* @__PURE__ */ jsxs(Fragment, { children: [
            viewsCount,
            " view",
            viewsCount > 1 ? "s" : ""
          ] }) })
...
const SEARCH_PREFIXES = ["#", "kind:"], LikeC4SearchInput = memo$1(() => {
  ...
  switch (!0) {
    ...
    case search.startsWith("#"): {
      ...
      ]) : (isExactMatch = alloptions.some((tag) => tag.toLocaleLowerCase() === searchTag), options = alloptions.map((tag) => /* @__PURE__ */ jsxs(ComboboxOption, { value: `#${tag}`, children: [
    ...
    case startingWithKind(search): {
      ...
      let alloptions = t$5(likec4model.specification.elements);
...
const dialogCss = css({
  ...
  try {
    ...
    return console.error(e2), !1;
  }
}, Search = memo$1(() => {
  const searchActorRef = useSearchActorRef(), emptyActorRef = useRef(createEmptyActor()), isOpened = useSelector(searchActorRef ?? emptyActorRef.current, selectIsOpened), close = useCallbackRef(() => {
    searchActorRef?.send({ type: "close" });
  });
  return useHotkeys(
    useMemo(() => {
  ...
  ), /* @__PURE__ */ jsx(AnimatePresence, { children: searchActorRef && isOpened && /* @__PURE__ */ jsx(
    Overlay,
    {
      fullscreen: !0,
      withBackdrop: !1,
...
function PortalToContainer({ children }) {
  ...
  return /* @__PURE__ */ jsx(Portal, { target: ctx.ref.current ?? ctx.selector, children });
}
...
}), RelationshipPopoverActorLogic = _actorLogic, Endpoint = ({ children, likec4color }) => /* @__PURE__ */ jsx(
  "div",
  {
...
const RelationshipPopover = memo$1(() => {
  ...
  const [direct, nested] = t$6(
    ...
    n$2(e$8),
    t$m((r2) => r2.source.id === sourceNode.id && r2.target.id === targetNode.id)
  );
  ...
  const ref = useRef(null), { enableNavigateTo, enableVscode } = useEnabledFeatures(), { onOpenSource } = useDiagramEventHandlers(), containerRef = useRootContainerRef(), [referenceEl, setReferenceEl] = useState(null);
  useLayoutEffect(() => {
        ...
        VStack,
        {
          ...
          children: [
            ...
            direct.length > 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
              /* @__PURE__ */ jsx(Label$2, { children: "DIRECT RELATIONSHIPS" }),
    ...
    VStack,
    {
      ...
      children: [
        /* @__PURE__ */ jsx(HStack, { gap: "0.5", children: /* @__PURE__ */ jsxs(TooltipGroup, { openDelay: 200, children: [
          /* @__PURE__ */ jsx(Tooltip$1, { label: sourceId.full, offset: 2, position: "top-start", children: /* @__PURE__ */ jsx(Endpoint, { likec4color: sourceNode.color, children: sourceId.short }) }),
          /* @__PURE__ */ jsx(IconArrowRight, { stroke: 2.5, size: "11px", opacity: 0.65 }),
          /* @__PURE__ */ jsx(Tooltip$1, { label: targetId.full, offset: 2, position: "top-start", children: /* @__PURE__ */ jsx(Endpoint, { likec4color: targetNode.color, children: targetId.short }) }),
        ...
        /* @__PURE__ */ jsxs(HStack, { gap: "xs", alignItems: "center", children: [
          /* @__PURE__ */ jsx(RelationshipTitle, { children: r2.title || "untitled" }),
        ...
        links.length > 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx(Label$2, { children: "links" }),
...
function getEndpointId(r2, endpoint, diagramNode) {
  const diagramNodeId = r2.isDeploymentRelation() ? diagramNode.id : diagramNode.modelRef || "", full = r2[endpoint].id, short = nameFromFqn(diagramNodeId) + full.slice(diagramNodeId.length);
  return { full, short };
}
...
const shapeBadge = css({
  ...
  return hasNotations ? /* @__PURE__ */ jsxs(AnimatePresence, { children: [
    isCollapsed && /* @__PURE__ */ jsx(
      m$1.div,
      {
        ...
        className: container,
        children: /* @__PURE__ */ jsx(Tooltip$7, { label: "Show notation", color: "dark", fz: "xs", ...portalProps, children: /* @__PURE__ */ jsx(
          ActionIcon,
          {
            size: "lg",
            variant: "default",
  ...
  const {
    ...
    enableReadOnly,
    enableCompareWithLatest
  } = useEnabledFeatures(), rerender = useRerender(), overlaysActorRef = useOverlaysActorRef(), handleReset = useCallback(() => {
  ...
  return /* @__PURE__ */ jsxs(ErrorBoundary, { onReset: handleReset, children: [
    ...
    enableSearch && /* @__PURE__ */ jsx(Search, {}),
...
function EdgeDrifts({
  edgeProps: { data: data2 },
  svgPath
}) {
  const drifts = data2.drifts;
...
function useControlPoints({
  ...
  const [controlPoints, setControlPoints] = useState(
    () => data2.controlPoints ?? bezierControlPoints(data2.points)
  );
  useUpdateEffect(() => {
    const next = data2.controlPoints ?? bezierControlPoints(data2.points);
  ...
  const insertControlPoint = useCallbackRef(({ x, y }) => {
    const sourceV = vector(sourceX, sourceY), targetV = vector(targetX, targetY), points = [
      data2.dir === "back" ? targetV : sourceV,
      ...controlPoints.map(vector) || [],
      data2.dir === "back" ? sourceV : targetV
...
const curve = d3line().curve(curveCatmullRomOpen.alpha(0.7)).x((d) => Math.trunc(d.x)).y((d) => Math.trunc(d.y));
function useRelationshipEdgePath({
  ...
  const [
    ...
    useCallback(({ nodeLookup }) => {
      const sourceNode = getNodeDimensions(nonNullable(nodeLookup.get(source), `source node ${source} not found`)), targetNode = getNodeDimensions(nonNullable(nodeLookup.get(target), `target node ${target} not found`));
      return [
  ...
  if (!(e$8(data2.controlPoints) || isControlPointDragging))
    return bezierPath(data2.points);
  const sourceCenterPos = vector(sourceX, sourceY).trunc(), targetCenterPos = vector(targetX, targetY).trunc(), sourceNd = {
    // Calculate node top-left from center position
    ...sourceCenterPos.subtract(vector(sourceNodeWidth, sourceNodeHeight).divide(2)).trunc().toObject(),
    width: sourceNodeWidth,
    height: sourceNodeHeight
  }, targetNd = {
    // Calculate node top-left from center position
    ...targetCenterPos.subtract(vector(targetNodeWidth, targetNodeHeight).divide(2)).trunc().toObject(),
    width: targetNodeWidth,
    height: targetNodeHeight
  }, nodeMargin = 6, points = data2.dir === "back" ? [
    targetCenterPos,
    getNodeIntersectionFromCenterToPoint(targetNd, n$4(controlPoints) ?? sourceCenterPos, nodeMargin),
    ...controlPoints,
    getNodeIntersectionFromCenterToPoint(sourceNd, t$b(controlPoints) ?? targetCenterPos, nodeMargin),
    sourceCenterPos
  ] : [
    sourceCenterPos,
    getNodeIntersectionFromCenterToPoint(sourceNd, n$4(controlPoints) ?? targetCenterPos, nodeMargin),
    ...controlPoints,
    getNodeIntersectionFromCenterToPoint(targetNd, t$b(controlPoints) ?? sourceCenterPos, nodeMargin),
    targetCenterPos
  ];
...
const getEdgeCenter = (path) => {
  ...
  } = props, navigateTo = enableNavigateTo && !isControlPointDragging ? data2.navigateTo : void 0, {
    controlPoints,
    setControlPoints,
    insertControlPoint
  ...
  const [labelPos, setLabelPos] = useSetState({
    x: labelXY?.x ?? labelX,
    y: labelXY?.y ?? labelY
  }, isSamePoint);
  useUpdateEffect(() => {
    isControlPointDraggingRef.current || setLabelPos({
      x: labelX,
      y: labelY
    });
  }, [labelX, labelY]);
  ...
  useRafEffect(() => {
    ...
    !path || !isControlPointDragging || setLabelPos(getEdgeCenter(path));
  ...
  const updateEdgeData2 = useCallbackRef((controlPoints2) => {
    ...
    point ? diagram.updateEdgeData(id, {
...
function ControlPoints({
  ...
  const xyflowStore = useXYStoreApi(), xyflow2 = useXYFlow(), edgeId = edgeProps.data.id, controlPointsRef = useRef(controlPoints);
  controlPointsRef.current = controlPoints;
  const onLmbControlPointerDown = (index2, e2, domNode) => {
    let hasMoved = !1, initialPoint = { x: e2.clientX, y: e2.clientY }, clientPoint = { ...initialPoint }, animationFrameId = null, cp = [...controlPointsRef.current];
    const onPointerMove = (e22) => {
      clientPoint.x = e22.clientX, clientPoint.y = e22.clientY, !isSamePoint(initialPoint, clientPoint) && (hasMoved || (hasMoved = !0, onStartMove()), animationFrameId ??= requestAnimationFrame(() => {
        animationFrameId = null;
        const { x, y } = xyflow2.screenToFlowPosition(clientPoint, { snapToGrid: !1 });
        cp = [...cp], cp[index2] = {
          x: Math.trunc(x),
          y: Math.trunc(y)
        }, onMove(cp);
      ...
      e22.stopPropagation(), domNode.removeEventListener("pointermove", onPointerMove, {
        ...
        capture: !0
      }), animationFrameId !== null && cancelAnimationFrame(animationFrameId), hasMoved ? onFinishMove(cp) : onCancelMove();
    };
    ...
    newControlPoints.length <= 1 || index2 >= newControlPoints.length || (stopAndPrevent(e2), newControlPoints.splice(index2, 1), setTimeout(() => {
    ...
    const index2 = parseFloat(e2.currentTarget.getAttribute("data-control-point-index") || "");
    if (isNaN(index2))
      throw console.error(e2.currentTarget), new Error("data-control-point-index is not a number");
    onRmbControlPointerDown(index2, e2);
  });
...
const DeploymentElementActions = ({
  extraButtons,
  ...props
}) => {
  const { enableNavigateTo, enableRelationshipBrowser } = useEnabledFeatures(), diagram = useDiagram(), { id, navigateTo, modelFqn } = props.data;
...
function NodeNotes({ data: data2 }) {
  return !hasProp(data2, "notes") || e$c(data2.notes.md || data2.notes.txt) ? null : /* @__PURE__ */ jsx(NodeNotesInternal2, { data: data2 });
}
function stopPropagation(e2) {
  e2.nativeEvent.stopImmediatePropagation(), e2.stopPropagation();
}
function NodeNotesInternal2({ data: data2 }) {
  return /* @__PURE__ */ jsx(NodeNotesInternal, { data: data2 });
}
function NodeNotesInternal({ data: data2 }) {
  const markdown = data2.notes, width = t(data2.width ?? 0, {
    min: 250,
    max: 500
  });
  t(data2.height ?? 0, {
  ...
  const [expanded, handlers] = useDisclosure(!1, {}), id = stringHash(data2.id + (markdown.md ?? markdown.txt)), onClickCapture = useCallbackRef((e2) => {
    e2 && (e2.preventDefault(), "nativeEvent" in e2 && e2.nativeEvent.stopImmediatePropagation(), e2.stopPropagation()), handlers.toggle();
  }), hovered = data2.hovered ?? !1, layoutDependency = expanded;
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(AnimatePresence, { children: [
      ...
      expanded && /* @__PURE__ */ jsx(ViewportPortal, { children: /* @__PURE__ */ jsx(
        m$1.div,
        {
          layout: !0,
          layoutDependency,
            ...
            ScrollAreaAutosize,
            {
              ...
              children: /* @__PURE__ */ jsx(
                Markdown,
                {
                  ...
                  value: RichText$1.from(markdown)
                }
              )
            }
          )
...
function Catch({
  ...
  return useOnDiagramEvent("paneClick", () => {
    onCatchClick();
  }), /* @__PURE__ */ jsx(ViewportPortal, { children: /* @__PURE__ */ jsx(
    Box,
    {
      css: {
        display: "block",
      ...
      style: {
        transform: `translate(${data2.x - 40}px, ${data2.y - 40}px)`,
        width: (data2.width ?? 250) + 80,
        height: (data2.height ?? 200) + 80
      },
...
const Tooltip = Tooltip$7.withProps({
  color: "dark",
  fz: "xs",
  openDelay: 400,
  closeDelay: 150,
...
function ColorSwatches({
  ...
  }, otherColors = t$5(theme.colors).filter((color) => !SemanticColors.includes(color));
  return /* @__PURE__ */ jsx(Stack, { gap: 2, onMouseLeave: () => onColorPreview(null), children: /* @__PURE__ */ jsxs(TooltipGroup, { openDelay: 1e3, closeDelay: 300, children: [
    /* @__PURE__ */ jsx(Flex, { maxW: "120px", gap: "1.5", justify: "flex-start", align: "flex-start", direction: "row", wrap: "wrap", children: SemanticColors.map((color) => /* @__PURE__ */ jsx(
      Tooltip$7,
      {
        label: color,
        fz: "xs",
...
function ElementToolbar(props) {
  const { enableVscode, enableRelationshipBrowser, enableNotes } = useEnabledFeatures(), increaseOffset = !!(enableNotes && props.data.notes), {
    data: {
      shape,
      modelFqn,
      style
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(
          MenuDropdown,
          {
            onDoubleClick: stopPropagation$1,
            onClick: stopPropagation$1,
            children: SortedElementShapes.map((shape) => /* @__PURE__ */ jsx(
              MenuItem,
              {
                fz: "sm",
                value: shape,
...
function ElementNode(props) {
  const { enableElementTags, enableElementDetails, enableReadOnly, enableCompareWithLatest, enableNotes } = useEnabledFeatures();
  return /* @__PURE__ */ jsxs(ElementNodeContainer, { nodeProps: props, children: [
    ...
    enableNotes && /* @__PURE__ */ jsx(NodeNotes, { ...props }),
    /* @__PURE__ */ jsx(DefaultHandles, { direction: props.data.viewLayoutDir })
  ] });
}
...
] }), hasModelFqn$1 = (node2) => "modelFqn" in node2.data && e$8(node2.data.modelFqn);
function SequenceActorNode(props) {
  const { enableElementDetails, enableReadOnly, enableCompareWithLatest, enableNotes } = useEnabledFeatures(), data2 = props.data, {
    id,
    positionAbsoluteY,
    data: {
      viewHeight,
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(ElementNodeContainer, { nodeProps: props, children: [
      ...
      /* @__PURE__ */ jsx(ElementShape, { ...props }),
      /* @__PURE__ */ jsx(ElementData, { ...props }),
      hasModelFqn$1(props) && /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(ElementActions, { ...props }),
        enableElementDetails && /* @__PURE__ */ jsx(ElementDetailsButtonWithHandler, { id, data: data2 }),
        !enableReadOnly && /* @__PURE__ */ jsx(ElementToolbar, { ...props })
      ] }),
      enableNotes && /* @__PURE__ */ jsx(NodeNotes, { ...props })
    ] }),
...
class Rect {
  ...
  set positionAbsolute(pos) {
    const x = Math.trunc(pos.x), y = Math.trunc(pos.y);
  ...
  constructor(xynode, parent = null) {
    ...
    this.maxX = this.minX + Math.ceil(width), this.maxY = this.minY + Math.ceil(height), this.initial = {
      x: this.minX,
      y: this.minY,
      width: Math.ceil(width),
      height: Math.ceil(height)
    ...
    return dx === 0 && dy === 0 ? {
      ...
      item: produce(current, (draft) => {
        draft.data.points = t$a(edge.data.points, (pt) => [pt[0] + dx, pt[1] + dy]), controlPoints ? draft.data.controlPoints = controlPoints.map((pt) => ({
          x: pt.x + dx,
          y: pt.y + dy
        })) : draft.data.controlPoints = null, edge.data.labelBBox && (draft.data.labelBBox ??= edge.data.labelBBox, draft.data.labelBBox.x = edge.data.labelBBox.x + dx, draft.data.labelBBox.y = edge.data.labelBBox.y + dy);
      })
    };
  };
}
function makeRelativeEdgeModifier(edge, movingRect, anchorNode, staticNode) {
  ...
  return (edgeLookup) => {
    ...
    const d = vector(dx, dy), relativePoint = (pt) => {
      const point = vector(pt), projLength = point.subtract(staticV).dot(staticToAnchor), coeff = t(projLength / staticToAnchorLength ** 2, {
        min: -1,
        max: 1
      }), newPoint = point.add(d.multiply(coeff)).trunc();
      return {
        x: newPoint.x,
        y: newPoint.y
      };
...
function createLayoutConstraints(xyflowApi, editingNodeIds) {
  ...
  const rectsToUpdate = [...rects.values()], edgeModifiers = /* @__PURE__ */ new Map(), findMovingAncestor = (nodeId) => {
    const r2 = rects.get(nodeId);
    if (r2)
      return r2;
    ...
    return null;
  }, movingNodes = new Set(editingNodeIds.flatMap((id) => [id, ...nestedOf.get(id)]));
  for (const edge of edges) {
    ...
    if (isSourceMoving && isTargetMoving) {
      ...
      invariant(!!r2, "At least one of the edge nodes should have a moving ancestor"), edgeModifiers.set(edge, makeEdgeModifier(edge, r2));
      continue;
    }
  ...
  function updateXYFlow() {
    ...
    for (const id of editingNodeIds) {
      ...
      const node2 = nodeLookup2.get(id);
      if (!node2) {
    ...
    for (const r2 of rectsToUpdate)
      ...
      }), r2 instanceof CompoundRect && nodeUpdates.push({
        id: r2.id,
        type: "dimensions",
        setAttributes: !0,
        resizing: !1,
    ...
    nodeUpdates.length > 0 && triggerNodeChanges(nodeUpdates);
    for (const fm of _edgeModifiers)
      edgeUpdates.push(fm(edgeLookup));
    edgeUpdates.length > 0 && triggerEdgeChanges(edgeUpdates);
  }
  ...
  function hasChanges() {
    return isome(rectsToUpdate, (r2) => r2.isMoved || r2.isResized);
  }
  return {
    rects,
    onMove,
...
function useLayoutConstraints() {
  ...
  return useMemo(() => ({
    onNodeDragStart: (_event, xynode) => {
      ...
      t$1(draggingNodes, 1) && (diagram.startEditing("node"), solverRef.current = createLayoutConstraints(xystore, draggingNodes));
    },
    onNodeDrag: (_event) => {
    ...
    onNodeDragStop: (_event) => {
      ...
      hasChanges ? solverRef.current.flushPending() : solverRef.current.cancelPending(), diagram.stopEditing(hasChanges), solverRef.current = void 0;
    }
  }), [xystore, diagram]);
}
const edgeTypes$1 = {
...
const viewportToTopLeft = (ctx) => {
...
}, selectXYProps = ({ context: ctx, children }) => {
  ...
  return ctx.dynamicViewVariant === "sequence" && ctx.view._type === "dynamic" && (nodesDraggable = !1), {
    enableReadOnly,
...
function LikeC4DiagramXYFlow({
  ...
  const {
    ...
    $isPanning.set(!0);
  }, isReducedGraphics ? 200 : 800), notPanning = useDebouncedCallback(() => {
    ...
    $isPanning.get() ? notPanning() : isPanning.start();
  }), onMoveEnd = useCallbackRef((event, viewport) => {
    event && notPanning(), diagram.send({
...
function _applyChangesToManualLayout(manualView, latestView) {
  ...
  }), bounds = BBox.merge(...nodes.filter(isRootNode));
  return produce(latestView, (draft) => {
...
function makeAsStraightLine(edge, sourceNode, targetNode) {
  ...
  return produce(edge, (draft) => {
    draft.points = castDraft(t$a(controlPoints, convertPoint)), draft.controlPoints = controlPoints, edge.labelBBox && (draft.labelBBox.x = labelPos.x, draft.labelBBox.y = labelPos.y), delete draft.drifts;
  });
}
function getBorderPointOnVector$1(node2, nodeCenter, v) {
  const xScale = node2.width / 2 / v.x, yScale = node2.height / 2 / v.y, scale = Math.min(Math.abs(xScale), Math.abs(yScale));
  return vector(v).multiply(scale).add(nodeCenter);
}
function edgeControlPoints(source, target) {
  const sourceCenter = vector(BBox.center(source)), targetCenter = vector(BBox.center(target));
  if (source === target) {
    const centerOfTopBoundary = vector(0, source.height || 0).multiply(-0.5).add(sourceCenter);
    return [
      centerOfTopBoundary.add(vector(-80 / 2.5, -80)).trunc().toObject(),
      centerOfTopBoundary.add(vector(80 / 2.5, -80)).trunc().toObject()
    ];
  }
...
function useEditorActorLogic() {
  const port = useOptionalLikeC4Editor(), applyLatest2 = useCallbackRef(
    async ({ input: { viewId, current } }) => {
      ...
      const manual = await promisify(() => current ?? port.fetchView(viewId, "manual")), latest = await promisify(() => port.fetchView(viewId, "auto"));
      return {
    ...
    async ({ input: input2 }) => {
      ...
      for (const change of input2.changes)
        await promisify(() => port.handleChange(input2.viewId, change));
      return {};
    }
  );
  return useMemo(() => editorActorLogic.provide({
    actors: {
      applyLatest: fromPromise(applyLatest2),
      executeChange: fromPromise(executeChange2)
    }
  }), [applyLatest2, executeChange2]);
}
function makeDiagramApi(actorRef) {
  return {
    ...
    updateNodeData: (nodeId, data2) => {
      actorRef.current.send({ type: "update.nodeData", nodeId, data: data2 });
    },
    updateEdgeData: (edgeId, data2) => {
      actorRef.current.send({ type: "update.edgeData", edgeId, data: data2 });
    },
...
function updateNodeData({ context: context2, event }) {
  return assertEvent(event, "update.nodeData"), { xynodes: context2.xynodes.map((node2) => {
    if (node2.id !== event.nodeId)
      return node2;
    const data2 = n$6(node2.data, event.data);
    return deepEqual(data2, node2.data) ? node2 : {
      ...node2,
      data: data2
    };
  }) };
...
function updateEdgeData({ context: context2, event }) {
  return assertEvent(event, "update.edgeData"), { xyedges: context2.xyedges.map((edge) => {
    if (edge.id !== event.edgeId)
      return edge;
    const data2 = n$6(edge.data, event.data);
    return deepEqual(data2, edge.data) ? edge : {
      ...edge,
      data: data2
    };
  }) };
...
function getBorderPointOnVector(node2, nodeCenter, v) {
  const dimensions = getNodeDimensions(node2), xScale = dimensions.width / 2 / v.x, yScale = dimensions.height / 2 / v.y, scale = Math.min(Math.abs(xScale), Math.abs(yScale));
  return vector(v).multiply(scale).add(nodeCenter);
}
...
function diagramToXY(opts) {
  const {
    view
  } = opts, xynodes = [], xyedges = [], nodeLookup = /* @__PURE__ */ new Map(), viewLayoutDir = view.autoLayout?.direction ?? "TB", queue = Queue.from(view.nodes.reduce(
    (acc, node2) => (nodeLookup.set(node2.id, node2), node2.parent || acc.push({ node: node2, parent: null }), acc),
    []
  ));
...
function toSeqStepEdge({ id, labelBBox, sourceHandle, targetHandle }, edge, currentViewId) {
  return {
    id,
    type: "seq-step",
    data: {
...
function convertToXYFlow({ dynamicViewVariant, ...params }) {
  const view = params.view, isDynamic = view._type === "dynamic", { xynodes, xyedges } = isDynamic && dynamicViewVariant === "sequence" ? sequenceLayoutToXY(view, params.currentViewId) : diagramToXY({ ...params });
    ...
    return [
      t$6(
        ...
        t$a(([id, position]) => {
          ...
          return invariant$1(originalRect, `Could not find original rect for node ${id}`), [t$n(originalRect, ["x", "y"]), position];
        }),
        t$a(
...
const setViewport = (params) => machine$2.createAction(({ context: context2, event }) => {
  let viewport, duration;
  params ? (viewport = params.viewport, duration = params.duration) : (assertEvent(event, "xyflow.setViewport"), viewport = event.viewport, duration = event.duration), duration = duration ?? 450;
...
}), setViewportCenter = (params) => machine$2.createAction(({ context: context2, event }) => {
  let center;
  params ? center = params : event.type === "update.view" ? center = BBox$1.center(viewBounds(context2, event.view)) : center = BBox$1.center(viewBounds(context2)), invariant$1(context2.xyflow, "xyflow is not initialized");
  const zoom = context2.xyflow.getZoom();
  context2.xyflow.setCenter(
    Math.round(center.x),
    Math.round(center.y),
    { zoom }
  ).catch((err) => {
...
}), centerOnNodeOrEdge = () => machine$2.raise(({ context: context2, event }) => {
  assertEvent(event, "xyflow.centerViewport");
  const xystate = context2.xystore.getState();
  if ("edgeId" in event) {
    const edge = xystate.edgeLookup.get(event.edgeId);
    if (!edge)
      return { type: "noop" };
    const sourceNode = xystate.nodeLookup.get(edge.source), targetNode = xystate.nodeLookup.get(edge.target);
    if (!sourceNode || !targetNode)
      return { type: "noop" };
    const bounds2 = getNodesBounds([sourceNode, targetNode], xystate), edgeBounds = calcEdgeBounds({
      points: edge.data.points,
      controlPoints: edge.data.controlPoints && isNonEmptyArray(edge.data.controlPoints) ? edge.data.controlPoints : null,
      labelBBox: edge.data.labelBBox ?? null
    });
    return {
      type: "xyflow.fitDiagram",
      bounds: BBox$1.merge(bounds2, edgeBounds)
    };
  }
  const node2 = xystate.nodeLookup.get(event.nodeId);
  return node2 ? {
    type: "xyflow.fitDiagram",
    bounds: getNodesBounds([node2], xystate)
  } : { type: "noop" };
}), fitDiagram$1 = (params) => machine$2.createAction(({ context: context2, event }) => {
  let bounds, duration;
  params ? (bounds = params.bounds, duration = params.duration) : event.type === "xyflow.fitDiagram" && (bounds = event.bounds, duration = event.duration), bounds ??= viewBounds(context2), duration ??= 450;
...
}), fitFocusedBounds = () => machine$2.createAction(({ context: context2 }) => {
...
}, cancelFitDiagram = () => machine$2.cancel("fitDiagram"), raiseFitDiagram = (params) => {
  const { delay: delay2 = DEFAULT_DELAY, ...rest } = params ?? {};
  return machine$2.raise(
    {
      type: "xyflow.fitDiagram",
...
}, raiseUpdateView = (view) => machine$2.raise(({ context: context2 }) => ({
  type: "update.view",
  view: context2.view
}), { delay: DEFAULT_DELAY }), assignViewportBefore = (viewport) => machine$2.assign(({ context: context2 }) => ({
  // We can assign
  viewportBefore: {
    wasChangedManually: context2.viewportChangedManually,
    value: { ...context2.viewport }
  }
})), returnViewportBefore = (params) => machine$2.enqueueActions(({ enqueue, context: { viewportBefore } }) => {
  enqueue(cancelFitDiagram());
  const noDelay = params?.delay === 0;
  viewportBefore ? (enqueue.assign({
    viewportChangedManually: viewportBefore.wasChangedManually,
    viewportBefore: null
  }), enqueue(noDelay ? setViewport({ viewport: viewportBefore.value, ...params }) : raiseSetViewport({ viewport: viewportBefore.value, ...params }))) : enqueue(noDelay ? fitDiagram$1({ ...params }) : raiseFitDiagram({ ...params }));
}), disableCompareWithLatest = () => machine$2.assign(({ context: context2 }) => ({
  toggledFeatures: {
...
})), onEdgeDoubleClick = () => machine$2.assign(({ context: context2, event }) => {
...
}), assignLastClickedNode = () => machine$2.assign(({ context: context2, event }) => {
...
}), assignFocusedNode = () => machine$2.assign(({ event }) => {
...
}), resetLastClickedNode = () => machine$2.assign(() => ({
  lastClickedNode: null
})), updateFeatures = () => machine$2.assign(({ context: context2, event }) => (assertEvent(event, "update.features"), {
  features: {
    ...context2.features,
    ...event.features
  }
})), updateInputs = () => machine$2.assign(({ event }) => (assertEvent(event, "update.inputs"), exact$1({ ...event.inputs }))), assignXYDataFromView = (view) => machine$2.assign(({ context: context2, event }) => {
  let xydata;
  assertEvent(event, "update.view"), xydata = "xynodes" in event ? event : convertToXYFlow({
    currentViewId: context2.view.id,
  ...
  return update;
}), focusOnNodesAndEdges = () => machine$2.enqueueActions(({ context: context2, enqueue }) => {
  const next = focusNodesEdges(context2);
  next ? enqueue.assign(next) : enqueue.raise({ type: "key.esc" });
}), undimEverything = () => machine$2.assign(({ context: context2 }) => ({
  xynodes: context2.xynodes.map(Base.setDimmed(!1)),
  xyedges: context2.xyedges.map(Base.setData({
    dimmed: !1,
    active: !1
  }))
})), assignDynamicViewVariant = () => machine$2.assign(({ event }) => (assertEvent(event, "switch.dynamicViewVariant"), {
  dynamicViewVariant: event.variant
})), onNodeMouseEnter = (params) => machine$2.assign(({ context: context2, event }) => {
...
}), onNodeMouseLeave = (params) => machine$2.assign(({ context: context2, event }) => {
  let node2 = params?.node;
...
}), emitPaneClick = () => machine$2.emit(() => ({
  type: "paneClick"
})), emitOpenSource = (params) => machine$2.emit(({ event }) => (assertEvent(event, "open.source"), {
  type: "openSource",
  params: event
})), emitOpenSourceOfView = () => machine$2.emit(({ context: context2 }) => ({
  type: "openSource",
  params: {
    view: context2.view.id
  }
})), emitInitialized = () => machine$2.emit(({ context: context2 }) => (invariant$1(context2.xyflow, "XYFlow instance not found"), {
  type: "initialized",
  instance: context2.xyflow
})), emitNodeClick = () => machine$2.emit(({ context: context2, event }) => (assertEvent(event, "xyflow.nodeClick"), {
  type: "nodeClick",
  node: nonNullable$1(findDiagramNode(context2, event.node.id), `Node ${event.node.id} not found in diagram`),
  xynode: event.node
})), emitNavigateTo = (params) => machine$2.emit(({ context: context2 }) => ({
  type: "navigateTo",
  viewId: params?.viewId ?? nonNullable$1(context2.lastOnNavigate, "Invalid state, lastOnNavigate is null").toView
})), emitEdgeClick = () => machine$2.emit(({ context: context2, event }) => (assertEvent(event, "xyflow.edgeClick"), {
  type: "edgeClick",
  edge: nonNullable$1(findDiagramEdge(context2, event.edge.id), `Edge ${event.edge.id} not found in diagram`),
  xyedge: event.edge
})), triggerChange = (viewChange) => machine$2.enqueueActions(({ event, enqueue }) => {
...
}), emitOnLayoutTypeChange = () => machine$2.enqueueActions(({ event, system, context: context2, enqueue }) => {
...
}), layoutAlign = (params) => machine$2.createAction(({ context: context2, event }) => {
  let mode;
  assertEvent(event, "layout.align"), mode = event.mode;
  const xystore = nonNullable$1(context2.xystore, "xystore is not initialized"), { nodeLookup, parentLookup } = xystore.getState(), selectedNodes = new Set(nodeLookup.values().filter((n2) => n2.selected).map((n2) => n2.id)), nodesToAlign = [...difference(selectedNodes, new Set(parentLookup.keys()))];
...
}), resetEdgesControlPoints = () => machine$2.assign(({ context: context2 }) => {
  const { nodeLookup } = context2.xystore.getState();
  return {
...
}), notationsHighlight = () => machine$2.assign(({ context: context2, event }) => {
...
}), tagHighlight = () => machine$2.assign(({ context: context2, event }) => (assertEvent(event, "tag.highlight"), {
  xynodes: context2.xynodes.map((n2) => n2.data.tags?.includes(event.tag) ? Base.setDimmed(n2, !1) : Base.setDimmed(n2, !0))
})), highlightNodeOrEdge = () => machine$2.assign(({ context: context2, event }) => {
  switch (assertEvent(event, ["highlight.edge", "highlight.node"]), event.type) {
    case "highlight.node": {
      const nodeId = event.nodeId;
      return context2.xynodes.find((n2) => n2.id === nodeId) ? {
        xynodes: context2.xynodes.map((n2) => Base.setDimmed(n2, n2.id !== nodeId)),
        xyedges: context2.xyedges.map(Base.setData({
          dimmed: !0,
          active: !1
        }))
    ...
    case "highlight.edge": {
      ...
      let edge = context2.xyedges.find((e2) => e2.id === edgeId);
      return edge ? {
        xynodes: context2.xynodes.map((n2) => Base.setDimmed(n2, edge.source !== n2.id && edge.target !== n2.id)),
        xyedges: context2.xyedges.map((e2) => Base.setData(e2, {
          dimmed: e2.id !== edgeId,
          active: e2.id === edgeId
        }))
...
}), assignToggledFeatures = () => machine$2.assign(({ context: context2, event }) => {
  assertEvent(event, "toggle.feature");
  const feature = `enable${event.feature}`, currentValue = context2.toggledFeatures[feature] ?? context2.features[feature], nextValue = event.forceValue ?? !currentValue;
  return {
    toggledFeatures: {
      ...context2.toggledFeatures,
      [feature]: nextValue
...
}), closeSearch = () => machine$2.sendTo(
  typedSystem.searchActor,
  {
    type: "close"
  }
), closeAllOverlays = () => machine$2.sendTo(
  typedSystem.overlaysActor,
  {
    type: "close.all"
  }
), stopEditorActor = () => machine$2.enqueueActions(({ enqueue, system }) => {
  const actor = typedSystem(system).editorActorRef;
  actor && enqueue.stopChild(actor);
}), ensureEditorActor = () => machine$2.enqueueActions(({ enqueue, context: context2, system, check }) => {
  const hasEditor = check("enabled: Editor"), editor2 = typedSystem(system).editorActorRef;
  if (!hasEditor && editor2) {
    enqueue.stopChild(editor2);
    return;
  }
  hasEditor && !editor2 && enqueue.spawnChild("editorActor", {
    id: "editor",
    systemId: "editor",
    input: {
...
}), startEditing = (subject = "node") => machine$2.sendTo(
  typedSystem.editorActor,
  {
    type: "edit.start",
    subject
  }
), sendSynced = () => machine$2.sendTo(
  typedSystem.editorActor,
  {
    type: "synced"
  }
), stopEditing = (wasChanged = !1) => machine$2.sendTo(
  typedSystem.editorActor,
  {
    type: "edit.finish",
    wasChanged
  }
), cancelEditing = () => machine$2.sendTo(
  typedSystem.editorActor,
  {
    type: "cancel"
  }
), hasModelFqn = (node2) => "modelFqn" in node2.data && e$8(node2.data.modelFqn), openElementDetails = (params) => machine$2.enqueueActions(({ context: context2, event, enqueue }) => {
...
}), openOverlay = () => machine$2.enqueueActions(({ context: context2, event, enqueue, check }) => {
  ...
  switch (event.type) {
    ...
    case "open.relationshipsBrowser": {
      if (!context2.features.enableRelationshipBrowser) {
    ...
    case "open.relationshipDetails": {
      if (!context2.features.enableRelationshipDetails) {
...
}), openSourceOfFocusedOrLastClickedNode = () => machine$2.enqueueActions(({ context: context2, enqueue }) => {
...
}), ensureOverlaysActor = () => machine$2.enqueueActions(({ enqueue, check, system }) => {
  const enabled = check("enabled: Overlays"), running = typedSystem(system).overlaysActorRef;
  if (enabled && !running) {
  ...
  !enabled && running && (enqueue.sendTo(running, {
    type: "close.all"
  }), enqueue.stopChild(running));
}), ensureSearchActor = () => machine$2.enqueueActions(({ enqueue, check, system }) => {
  const enabled = check("enabled: Search"), running = typedSystem(system).searchActorRef;
  if (enabled && !running) {
...
}), onEdgeMouseEnter = () => machine$2.enqueueActions(({ enqueue, context: context2, event }) => {
...
}), onEdgeMouseLeave = () => machine$2.enqueueActions(({ enqueue, context: context2, event }) => {
...
}), startHotKeyActor = () => machine$2.spawnChild("hotkeyActorLogic", { id: "hotkey" }), stopHotKeyActor = () => machine$2.stopChild("hotkey"), AUTO_UNFOCUS_DELAY = 3e3, startAutoUnfocusTimer = () => machine$2.enqueueActions(({ context: context2, enqueue }) => {
...
}), cancelAutoUnfocusTimer = () => machine$2.cancel("autoUnfocusTimer"), handleNavigate = () => machine$2.enqueueActions(({ enqueue, context: context2, event }) => {
  ...
  let { currentIndex, history: _history } = navigationHistory, history = _history;
  if (currentIndex < _history.length) {
    const updatedEntry = produce(_history.at(currentIndex) ?? {}, (draft) => {
      draft.viewport = { ...viewport }, draft.viewportChangedManually = viewportChangedManually, draft.focusedNode = focusedNode, view._type === "dynamic" ? (draft.activeWalkthrough = activeWalkthrough?.stepId ?? null, draft.dynamicViewVariant = dynamicViewVariant) : (draft.activeWalkthrough = null, draft.dynamicViewVariant = null), viewportBefore ? draft.viewportBefore = structuredClone(viewportBefore) : delete draft.viewportBefore;
    });
...
}), updateView$1 = () => machine$2.enqueueActions(
  ({ enqueue, event, context: context2 }) => {
    ...
    if (enqueue(assignXYDataFromView()), event.source === "editor")
      return;
    if (enqueue(sendSynced()), context2.toggledFeatures.enableCompareWithLatest === !0 && context2.view._layout !== nextView._layout) {
    ...
    if (recenter = recenter || context2.toggledFeatures.enableCompareWithLatest === !0 && !!nextView._layout && context2.view._layout !== nextView._layout, nextView._type === "dynamic" && context2.view._type === "dynamic" && nextView.variant === context2.view.variant && nextView.variant !== context2.dynamicViewVariant) {
      const nextCenter = BBox.center(viewBounds(context2, nextView));
      enqueue(setViewportCenter(nextCenter));
    }
    recenter && (enqueue(cancelFitDiagram()), enqueue(raiseFitDiagram()));
  }
), initializing = machine$2.createStateConfig({
  on: {
    "xyflow.init": {
...
}), isReady = machine$2.createStateConfig({
  always: [{
    guard: "isReady",
    actions: [
...
}), handleBrowserForwardBackward = () => machine$2.assign(({ context: context2, event }) => {
  ...
  return {};
}), navigating = machine$2.createStateConfig({
  ...
  always: {
    ...
    actions: [
      ...
      enqueueActions(({ enqueue, context: context2, event }) => {
        ...
        const currentViewport = xyflow2.getViewport(), calcZoomTowardsNextViewport = (nextViewport2) => {
          const zoom = currentViewport.zoom, diff = nextViewport2.zoom - zoom;
          if (Math.abs(diff) < 0.01)
            return nextViewport2.zoom;
          const coef = diff < 0 ? 0.6 : 0.3;
          return Math.trunc(1e4 * (zoom + diff * coef)) / 1e4;
        }, moveTowardsNextViewport = (nextViewport2) => {
          const zoom = calcZoomTowardsNextViewport(nextViewport2);
          zoom !== nextViewport2.zoom ? (xyflow2.setViewport({
            x: roundDpr(nextViewport2.x * (1 + currentViewport.zoom - zoom)),
            y: roundDpr(nextViewport2.y * (1 + currentViewport.zoom - zoom)),
            zoom
          }), enqueue(raiseSetViewport({
            delay: 100,
            viewport: nextViewport2
          }))) : xyflow2.setViewport(nextViewport2, { duration: 0 });
        ...
        if (fromHistory && fromHistory.viewId === eventWithXYData.view.id) {
          ...
          if (enqueue.assign(nextCtx), moveTowardsNextViewport(nextCtx.viewport), wasFocused) {
            enqueue.raise({
              type: "focus.node",
              nodeId: wasFocused
            }, { delay: 150 });
        ...
        const nextBounds = viewBounds(context2, eventWithXYData.view), nextViewport = calcViewportForBounds(
          context2,
          nextBounds
        ...
        if (fromNode && toNode) {
          ...
          if (zoom !== nextViewport.zoom) {
            const { width, height } = context2.xystore.getState(), nextCenter = BBox.center(nextBounds), paddings = parsePaddings(context2.fitViewPadding, width, height);
            xyflow2.setViewport({
              x: roundDpr(
                (width - paddings.x) / 2 - nextCenter.x * zoom + paddings.left
              ),
              y: roundDpr(
                (height - paddings.y) / 2 - nextCenter.y * zoom + paddings.top
              ),
              zoom
            }), enqueue(raiseSetViewport({
              delay: 100,
            ...
            xyflow2.setViewport(nextViewport, { duration: 0 });
        }
        const updatedHistory = currentIndex < history.length - 1 ? history.slice(0, currentIndex + 1) : [...history];
        updatedHistory.length > 20 && updatedHistory.shift(), updatedHistory.push({
...
}), focused = machine$2.createStateConfig({
...
}), idle$2 = machine$2.createStateConfig({
...
}), printing = machine$2.createStateConfig({
  id: targetState.printing.slice(1),
  entry: [
    cancelFitDiagram(),
    assignViewportBefore(),
    enqueueActions(({ enqueue, context: context2 }) => {
      const bounds = viewBounds(context2), OFFSET = 16;
      enqueue(
        setViewport({
          viewport: {
            x: bounds.x + OFFSET,
...
}), updateActiveWalkthroughState = () => machine$2.enqueueActions(({ context: context2, enqueue }) => {
...
}), emitWalkthroughStarted = () => machine$2.emit(({ context: context2 }) => {
...
}), emitWalkthroughStopped = () => machine$2.emit(() => ({
  type: "walkthroughStopped"
})), emitWalkthroughStep = () => machine$2.emit(({ context: context2 }) => {
  const edge = context2.xyedges.find((x) => x.id === context2.activeWalkthrough?.stepId);
  return invariant$1(edge, "Invalid walkthrough state"), {
    type: "walkthroughStep",
    edge
  };
}), walkthrough = machine$2.createStateConfig({
      ...
      actions: [
        assign(({ context: context2, event }) => {
          ...
          if (nextStepIndex === stepIndex)
            return {};
          const nextStepId = nonNullable$1(context2.xyedges[nextStepIndex]).id;
          return {
            activeWalkthrough: {
              stepId: nextStepId,
      ...
      },
      {
        actions: [
          assign(({ event }) => {
            ...
            return invariant$1(isStepEdgeId(stepId)), {
              activeWalkthrough: {
                stepId,
                parallelPrefix: getParallelStepsPrefix(stepId)
              }
...
}), ready = machine$2.createStateConfig({
  initial: "idle",
  entry: [
  ...
  write(toggledFeatures) {
    return sessionStorage.setItem(key$1, JSON.stringify(t$2(toggledFeatures, e$d))), toggledFeatures;
  }
}, _diagramMachine = machine$2.createMachine({
  initial: "initializing",
  context: ({ input: input2 }) => ({
    ...input2,
    xyedges: [],
  ...
  on: {
    ...
    "xyflow.applyChanges": {
      actions: assign(({ context: context2, event }) => ({
        xynodes: event.nodes ? applyNodeChanges(event.nodes, context2.xynodes) : context2.xynodes,
        xyedges: event.edges ? applyEdgeChanges(event.edges, context2.xyedges) : context2.xyedges
      }))
    },
...
function DiagramActorProvider({
  ...
  const xystore = useStoreApi(), editorActor = useEditorActorLogic(), features = useEnabledFeatures(), actor = useActorRef(
  ...
  return useEffect(() => {
    setApi((api2) => api2.ref === actorRef ? api2 : (console.error(
  ...
  }, [actor, features]), useUpdateEffect(
    () => actor.send({
      type: "update.inputs",
  ...
  }, [actor, _defaultVariant]), useEffect(
    ...
    /* @__PURE__ */ jsx(ErrorBoundary, { children: /* @__PURE__ */ jsx(ToggledFeatures, { children }) }),
    /* @__PURE__ */ jsx(PropagateDiagramActorEvents, {})
  ] }) });
}
const selectToggledFeatures = selectDiagramActorContext((context2) => {
  let toggledFeatures = context2.toggledFeatures;
  const enableCompareWithLatest = context2.view.drifts != null && context2.view.drifts.length > 0 && context2.features.enableCompareWithLatest && (toggledFeatures.enableCompareWithLatest ?? !1) && e$6(context2.activeWalkthrough), enableReadOnly = context2.features.enableReadOnly || toggledFeatures.enableReadOnly || !!context2.activeWalkthrough || enableCompareWithLatest && context2.view._layout === "auto";
...
function ToggledFeatures({ children }) {
  const toggledFeatures = useDiagramSnapshot(selectToggledFeatures);
  return useUpdateEffect(() => {
    DiagramToggledFeaturesPersistence.write(toggledFeatures);
  }, [toggledFeatures]), /* @__PURE__ */ jsx(DiagramFeatures, { overrides: toggledFeatures, children });
}
const PropagateDiagramActorEvents = memo$1(() => {
  const diagram = useDiagram(), handlers = useDiagramEventHandlersRef();
  return useOnDiagramEvent("openSource", ({ params }) => handlers.current.onOpenSource?.(params)), useOnDiagramEvent("navigateTo", ({ viewId }) => handlers.current.onNavigateTo?.(viewId)), useOnDiagramEvent("onLayoutTypeChange", ({ layoutType }) => {
    handlers.current.onLayoutTypeChange?.(layoutType);
  }), useOnDiagramEvent(
    "initialized",
    ({ instance: xyflow2 }) => {
      try {
        handlers.current.onInitialized?.({ diagram, xyflow: xyflow2 });
      } catch (error) {
        console.error(error);
      }
    },
...
}), scheme = (scheme2) => `[data-mantine-color-scheme="${scheme2}"]`, whenDark = scheme("dark"), generateCompoundColors = (rootSelector, name, colors, depth) => `
${`${rootSelector} :is([data-likec4-color="${name}"][data-compound-depth="${depth}"])`} {
  --likec4-palette-fill: ${colors.fill};
  --likec4-palette-stroke: ${colors.stroke};  
}
  `;
function toStyle(styles, params) {
  const { rootSelector, name, colors } = params, { elements, relationships } = colors, selector3 = `${rootSelector} :is([data-likec4-color=${name}])`;
  return [
    `
${selector3} {
...
${whenDark} ${selector3} {
  ...
  `,
    ...styles.colorsForCompounds(elements, MAX_COMPOUND_DEPTH).map(
      (colors2, depth) => generateCompoundColors(rootSelector, name, colors2, depth + 1)
    )
  ].map((s) => s.trim()).join(`
`);
}
...
function LikeC4Styles({ id }) {
  const rootSelector = `#${id}`, nonce = useMantineStyleNonce()?.(), $styles = useLikeC4Styles(), colorsStyles = useMemo(() => generateBuiltInColorStyles($styles, rootSelector), [rootSelector, $styles]);
  return /* @__PURE__ */ jsx(
    MemoizedStyle,
    {
      id,
...
const MemoizedStyle = memo$1(({ id, nonce, colorsStyles }) => /* @__PURE__ */ jsx(
  "style",
  {
    type: "text/css",
...
function LikeC4Diagram({
  ...
  const id = useId(), initialRef = useRef(null), optionalLikeC4Model = useOptionalLikeC4Model();
  enableCompareWithLatest = enableCompareWithLatest && !!onLayoutTypeChange && !!optionalLikeC4Model && !e$c(optionalLikeC4Model.$data.manualLayouts);
  const hasLikeC4Model = !!optionalLikeC4Model, hasEditor = !!useOptionalLikeC4Editor(), readonly = !hasEditor;
  ...
  const isReducedGraphicsMode = reduceGraphics === "auto" ? pannable && view.bounds.width * view.bounds.height > 16e6 && view.nodes.some((n2) => n2.children?.length > 0) : reduceGraphics;
  return /* @__PURE__ */ jsx(Profiler, { id: "LikeC4Diagram", onRender: noop$1, children: /* @__PURE__ */ jsx(EnsureMantine, { children: /* @__PURE__ */ jsx(FramerMotionConfig, { reducedMotion: isReducedGraphicsMode ? "always" : void 0, children: /* @__PURE__ */ jsx(IconRendererProvider, { value: renderIcon ?? null, children: /* @__PURE__ */ jsx(
    DiagramFeatures,
    {
      features: {
              ...
              ReactFlowProvider,
              {
                ...
                children: /* @__PURE__ */ jsx(
                  DiagramActorProvider,
                  {
                    ...
                    where: where ?? null,
                    dynamicViewVariant,
                    children: /* @__PURE__ */ jsxs(CurrentViewModelProvider, { children: [
                      /* @__PURE__ */ jsx(
                        LikeC4DiagramXYFlow,
                        {
                          background,
...
function useNormalizedViewPadding(raw) {
  return useCustomCompareMemo(
    () => {
      if (e$e(raw))
        return t$k(raw, toLiteralPaddingWithUnit);
...
function LikeC4ModelProvider({
  ...
  return /* @__PURE__ */ jsx(LikeC4ModelContextProvider, { value: likec4model, children });
}
function LikeC4ProjectsProvider({
  ...
  useEffect(() => {
    outerScope && console.warn("LikeC4ProjectsProvider should not be nested inside another one");
  }, []);
  const onProjectChange2 = useCallbackRef(_onProjectChange), [value, setValue] = useState(() => ({ projects, onProjectChange: onProjectChange2 }));
  return useEffect(() => {
    setValue((current) => deepEqual(current.projects, projects) ? current : { ...current, projects });
  }, [projects]), /* @__PURE__ */ jsx(LikeC4ProjectsContextProvider, { value, children });
}
...
const key = "likec4:projects-overview:lastViewport", ProjectsOverviewViewportPersistence = {
  ...
  guards: {
    ...
    "click: selected node": ({ event }) => event.type === "xyflow.click.node" && event.node.selected === !0
  }
}), updateView = () => machine$1.assign(({ event }) => {
  assertEvent(event, "update.view");
...
}), xyflowApplyNodeChanges = () => machine$1.assign(({ context: context2, event }) => (assertEvent(event, "xyflow.applyNodeChanges"), {
  xynodes: applyNodeChanges(event.changes, context2.xynodes)
})), xyflowApplyEdgeChanges = () => machine$1.assign(({ context: context2, event }) => (assertEvent(event, "xyflow.applyEdgeChanges"), {
  xyedges: applyEdgeChanges(event.changes, context2.xyedges)
})), onMouseEnterOrLeave = () => machine$1.assign(({ context: context2, event }) => {
  assertEvent(event, [
...
}), saveViewport = () => machine$1.createAction(({ context: context2 }) => {
  const xyflow2 = context2.xyflow;
  xyflow2 && ProjectsOverviewViewportPersistence.write(xyflow2.getViewport());
}), handleClick = () => machine$1.enqueueActions(({ event, enqueue }) => {
  if (event.type === "xyflow.click.double") {
    enqueue(fitDiagram());
    return;
  }
}), fitDiagram = (params) => machine$1.enqueueActions(({ context: context2, event }) => {
...
}), restoreViewport = () => machine$1.enqueueActions(({ context: context2, enqueue }) => {
  ...
  xyedges: [],
  xynodes: []
}), assignNavigateTo = () => machine$1.assign(({ event, context: context2 }) => {
  let navigateTo;
  switch (event.type) {
...
}), _projectOverviewLogic = machine$1.createMachine({
...
const ProjectsOverviewActorContext = createContext$1(null), ProjectsOverviewActorContextProvider = ProjectsOverviewActorContext.Provider;
...
const { withProvider, withContext: withContext$1 } = createStyleContext(navigationPanel), shouldForwardProp = (prop, variantKeys) => !variantKeys.includes(prop) && (isValidMotionProp(prop) || !isCssProperty(prop)), LogoButton = forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsxs(
  "button",
  {
    ...props,
    ref,
    ...
    children: [
      /* @__PURE__ */ jsx(LogoIcon, { "data-logo-icon": !0 }),
      /* @__PURE__ */ jsx(Logo$1, { "data-logo-full": !0 })
    ]
  }
)), Root$1 = withProvider(MotionDiv, "root", {
  shouldForwardProp
}), Body = withContext$1(MotionDiv, "body", {
  shouldForwardProp
}), Logo = withContext$1(LogoButton, "logo"), Label$1 = withContext$1(MotionDiv, "label", {
  shouldForwardProp
});
withContext$1(MotionDiv, "dropdown", {
  shouldForwardProp
});
...
function ProjectsOverview({
  ...
  return /* @__PURE__ */ jsx(ProjectsOverviewActorContextProvider, { value: actorRef, children: /* @__PURE__ */ jsxs(ReactFlowProvider, { ...initialRef.current, children: [
...
const statebtn = cva({
  ...
  variants: {},
  defaultVariants: {}
}), { withRootProvider, withContext } = createStyleContext(tree), Root = withRootProvider("div"), Branch = withContext("div", "branch"), Item = withContext("div", "item", {
  forwardProps: [],
  defaultProps: {
    className: "group"
  }
}), Control = withContext("div", "control", {
  forwardProps: [],
  defaultProps: {
    className: "group"
  }
}), ElementState = ({ node: node2, state, onClick, className, ...props }) => {
  const cls = cx(
    className,
    "mantine-active",
    statebtn({ state })
  );
  return /* @__PURE__ */ jsx("div", { ...props, onClick, className: cls, children: state });
}, State$1 = withContext(ElementState, "state", {
  forwardProps: ["node", "state", "onClick", "className"]
}), Icon = withContext(IconOrShapeRenderer, "icon", {
  forwardProps: ["element", "className"]
}), Label = withContext("div", "label", {
  forwardProps: []
}), Content = withContext("div", "content", {
  forwardProps: []
}), Indicator = withContext(IconChevronRight, "indicator", {
  forwardProps: [],
  defaultProps: {
    size: 14
  }
  ...
  Content,
  Indicator
}, AdhocEditorActorContext = createContext$1(null), AdhocEditorActorContextProvider = AdhocEditorActorContext.Provider;
function useAdhocEditorActor() {
  return nonNullable$1(useContext(AdhocEditorActorContext), "No AdhocEditorActorContext");
}
const EMPTY_VIEW = {
  id: "adhoc",
  _type: "element",
  ...
  description: null,
  hash: ""
}, selectView = ({ context: context2 }) => context2.view ?? EMPTY_VIEW;
...
function getElementState(id, states) {
  return states ? states.disabled.has(id) ? "disabled" : states.includedExplicit.has(id) ? "include-explicit" : states.includedImplicit.has(id) ? "include-implicit" : states.excluded.has(id) ? "exclude" : "not-present" : "not-present";
}
...
function useElementsTree() {
  const { searchInput, collection: collection2 } = useEditorPanelState(select), lowerCaseInput = useDeferredValue(searchInput), filteredCollection = useMemo(() => lowerCaseInput ? collection2.filter((c) => c.title.toLowerCase().includes(lowerCaseInput)) : collection2, [collection2, lowerCaseInput]), [expandedValue, setExpandedValue] = useState([]);
  useEffect(() => {
    filteredCollection !== collection2 && setExpandedValue((current) => {
      const newBranches = r$1(filteredCollection.getBranchValues(), current);
      return t$1(newBranches, 1) ? t$l([...current, ...newBranches], compareNaturalHierarchically()) : current;
    });
  }, [filteredCollection]);
  const service = useMachine(machine$6, {
    id: useId(),
    collection: filteredCollection,
    defaultCheckedValue: [],
    defaultSelectedValue: [],
    expandedValue,
    onExpandedChange({ expandedValue: expandedValue2 }) {
      setExpandedValue(expandedValue2);
    },
    // checkedValue,
  ...
  return api.select, useOnEditorPanelEvent("inputKeyDown", () => {
    const first = api.collection.getFirstNode()?.id;
    first && api.focus(first);
  }), api;
}
function deriveElementStates({ rules, view }) {
  const includedInView = new Set(view ? view.nodes.map((node2) => node2.modelRef ?? null).filter(e$b) : []), explicits = t$6(
    rules,
    n$2((r2) => r2.type === "include" && r2.enabled),
    t$a((r2) => r2.expr.ref.model),
    toSet()
  ), excluded = t$6(
    rules,
    n$2((r2) => r2.type === "exclude" && r2.enabled),
    t$a((r2) => r2.expr.ref.model),
    toSet()
  );
  return {
...
const createEditorPanelStore = ({
  ...
  on: {
    inputChange: (context2, event) => ({
      ...context2,
      searchInput: event.value
    }),
    inputKeyDown: (context2, event, enqueue) => {
      enqueue.emit.inputKeyDown();
    },
    modelUpdate: (context2, event) => ({
      ...context2,
      collection: event.collection
    }),
    elementClick: (context2, event, enqueue) => {
      const current = context2.collection.findNode(event.id), path = context2.collection.getIndexPath(event.id);
      return !current || !path || enqueue.effect(() => {
        sideEffects.onElementStateClick({ id: event.id });
      }), context2;
    }
  }
}), EditorPanelStoreContext = createContext$1(null), EditorPanelStoreProvider = (props) => {
  const likec4model = useLikeC4Model(), likec4modelRef = useRef(likec4model);
  likec4modelRef.current = likec4model;
  const actorRef = useAdhocEditorActor(), store = useMemo(() => createEditorPanelStore({
  ...
  }, [actorRef]), /* @__PURE__ */ jsx(EditorPanelStoreContext.Provider, { value: store, children: props.children });
};
function selectEditorPanelState(selector3, compare2) {
  return [
    (snapshot) => selector3(snapshot.context),
    compare2 ?? shallowEqual$1
  ];
}
function useEditorPanelStore() {
  return useContext(EditorPanelStoreContext);
}
function useEditorPanelState(...args) {
  const store = useEditorPanelStore();
  let selector3, compare2;
  if (args.length === 2)
    [selector3, compare2] = args;
  else if (args.length === 1 && Array.isArray(args[0]) && t$1(args[0], 2))
    [selector3, compare2] = args[0];
  else if (args.length === 1 && Array.isArray(args[0]) && t$1(args[0], 1))
    [selector3, compare2] = [args[0], shallowEqual$1];
  else if (args.length === 1 && typeof args[0] == "function")
    [selector3, compare2] = [args[0], shallowEqual$1];
  else
    throw new Error("Invalid arguments for useEditorPanelState");
  return useSelector$1(store, selector3, compare2);
}
function useOnEditorPanelEvent(...args) {
  const store = useEditorPanelStore(), event = args[0], handler = useCallbackRef(args[1]);
  useEffect(() => {
...
function useEditorPanelTrigger(...args) {
  const store = useEditorPanelStore();
  if (args.length === 0)
    return store.trigger;
  const trigger = args[0];
  return useCallbackRef((...args2) => {
    trigger(store.trigger, ...args2);
  });
}
const ElementsTree = memo$1(() => {
  const api = useElementsTree(), onClick = useEditorPanelTrigger((trigger, event) => {
    const id = event.currentTarget.closest("[data-value]")?.getAttribute("data-value");
    if (id)
      try {
        event.stopPropagation(), event.preventDefault(), api.expand([id]), trigger.elementClick({ id });
      } catch (err) {
        console.error("Failed to handle element click", err);
      }
  }), rootProps = mergeProps$1(api.getRootProps(), {
    onKeyDown: (e2) => {
      switch (e2.key) {
        case "Escape": {
          const input2 = document.getElementById("search-input");
          input2 && (e2.stopPropagation(), e2.preventDefault(), input2.focus());
          break;
        }
        case "ArrowUp": {
          console.log("ArrowUp", {
  ...
  return /* @__PURE__ */ jsx(
    ScrollArea,
    {
      ...
      // }}
      ...rootProps,
      children: /* @__PURE__ */ jsxs(Tree.Root, { ...api.getTreeProps(), children: [
        api.collection.rootNode.children.map((node2, index2) => /* @__PURE__ */ jsx(
          TreeNode,
          {
            node: node2,
            api,
        ...
        !api.collection.getFirstNode() && /* @__PURE__ */ jsx(
          Box,
          {
            css: {
              p: "4",
...
}), TreeNode = ({ api, node: node2, onClick }) => {
  const indexPath = api.collection.getIndexPath(node2.id);
  invariant(indexPath, "Node not found in collection");
  const nodeProps = { indexPath, node: node2 }, state = api.getNodeState(nodeProps);
  return state.isBranch ? /* @__PURE__ */ jsxs(Tree.Branch, { ...api.getBranchProps(nodeProps), children: [
    /* @__PURE__ */ jsxs(Tree.Control, { ...api.getBranchControlProps(nodeProps), children: [
      /* @__PURE__ */ jsx(Tree.Icon, { element: node2 }),
      /* @__PURE__ */ jsxs(Tree.Label, { ...api.getBranchTextProps(nodeProps), children: [
        node2.title,
        /* @__PURE__ */ jsx(Tree.Indicator, { ...api.getBranchIndicatorProps(nodeProps) })
      ] }),
      /* @__PURE__ */ jsx(Tree.State, { node: node2, state: node2.state, onClick })
    ] }),
    /* @__PURE__ */ jsx(Tree.Content, { ...api.getBranchContentProps(nodeProps), children: state.expanded && node2.children.map((childNode, index2) => /* @__PURE__ */ jsx(
      TreeNode,
      {
        node: childNode,
        api,
  ...
  ] }) : /* @__PURE__ */ jsxs(Tree.Item, { ...api.getItemProps(nodeProps), children: [
    /* @__PURE__ */ jsx(Tree.Icon, { element: node2 }),
    /* @__PURE__ */ jsx(Tree.Label, { ...api.getItemTextProps(nodeProps), children: node2.title }),
    /* @__PURE__ */ jsx(Tree.State, { node: node2, state: node2.state, onClick })
  ] });
}, EditorPanel = () => /* @__PURE__ */ jsx(EditorPanelStoreProvider, { children: /* @__PURE__ */ jsx(AnimatePresence, { mode: "popLayout", children: /* @__PURE__ */ jsxs(
  VStack,
  {
    css: {
      position: "fixed",
    ...
    children: [
      /* @__PURE__ */ jsxs(HStack, { p: "2", gap: "4", justifyItems: "stretch", children: [
        /* @__PURE__ */ jsx(Logo$1, { style: { height: 16 } }),
        /* @__PURE__ */ jsx(Txt, { size: "sm", fontWeight: "medium", flex: "1", children: "Explore" }),
        /* @__PURE__ */ jsx(HStack, { gap: "1", children: /* @__PURE__ */ jsx(ActionIcon, { children: /* @__PURE__ */ jsx(IconTrash, {}) }) })
      ] }),
      /* @__PURE__ */ jsx(Box, { children: /* @__PURE__ */ jsx(SearchInput, {}) }),
      /* @__PURE__ */ jsx(Suspense, { children: /* @__PURE__ */ jsx(ElementsTree, {}) })
    ]
  }
) }) }), selectInput = selectEditorPanelState(e$5("searchInput"));
function SearchInput() {
  const input2 = useEditorPanelState(selectInput), trigger = useEditorPanelTrigger(), onChange = useEditorPanelTrigger((trigger2, event) => {
    trigger2.inputChange({ value: event.currentTarget.value });
  }), clear = useEditorPanelTrigger((trigger2) => {
    trigger2.inputChange({ value: "" });
  });
    ...
    Input,
    {
      ...
      rightSection: /* @__PURE__ */ jsx(
        CloseButton,
        {
          ...
          onClick: clear,
          style: { display: input2 ? void 0 : "none" }
        }
      ),
      onKeyDownCapture: (e2) => {
        switch (e2.key) {
          case "Escape": {
            e2.stopPropagation(), e2.preventDefault(), clear();
            break;
          }
          case "Enter": {
            e2.stopPropagation(), e2.preventDefault();
          ...
          case "ArrowDown": {
            e2.stopPropagation(), e2.preventDefault(), trigger.inputKeyDown();
            break;
          }
          default:
            return;
...
const machine = setup({
  ...
  guards: {
    hasView: ({ context: context2 }) => context2.view !== null
  }
});
...
}, idle$1 = machine.createStateConfig({
  id: to$1.idle.target.substring(1),
...
}), emitViewUpdate = () => machine.emit({ type: "view.update" }), selectEnabled = t$o(
  n$2((rule) => rule.enabled),
  t$a(ruleToPredicate)
), call = machine.createStateConfig({
  id: to$1.call.target.substring(1),
  entry: log("entry call ->"),
  exit: log(" -> call exit "),
  invoke: {
    src: "service",
    input: ({ context: context2 }) => ({
      predicates: selectEnabled(context2.rules)
    }),
    onDone: {
      actions: [
        assign({
          view: ({ context: context2, event }) => {
            const id = objectHash(selectEnabled(context2.rules));
            return {
              ...event.output.view,
              hash: id,
              id
...
}), layouter = machine.createStateConfig({
  initial: "idle",
  states: {
    idle: idle$1,
    call
...
function nextId({ rules }, salt = "") {
  return stringHash((rules.at(-1)?.id ?? (/* @__PURE__ */ new Date()).toISOString()) + salt);
}
const isRuleOf = (fqn2) => (rule) => ModelFqnExpr.isModelRef(rule.expr) && rule.expr.ref.model === fqn2, isIncludeOf = (fqn2) => (rule) => rule.type === "include" && ModelFqnExpr.isModelRef(rule.expr) && rule.expr.ref.model === fqn2, isExcludeOf = (fqn2) => (rule) => rule.type === "exclude" && ModelFqnExpr.isModelRef(rule.expr) && rule.expr.ref.model === fqn2;
function deriveElementState(id, { rules, view }) {
  ...
  const isIncludedInView = view ? view.nodes.some((node2) => node2.modelRef === id) : !1, includeRule = rules.find(isIncludeOf(id)), excludeRule = rules.find(isExcludeOf(id));
  switch (!0) {
    ...
    default:
      return invariant(isIncludedInView === !1, "Element not in view should not be included or excluded by any rule"), {
        state: "not-present",
        ruleId: void 0
      };
  }
}
const enableRule = (ruleId) => machine.assign(({ context: context2 }) => ({
  rules: context2.rules.map((rule) => rule.id === ruleId && !rule.enabled ? {
    ...rule,
    enabled: !0
  } : rule)
})), addElementRules = (fqn2, type) => machine.assign(({ context: context2 }) => ({
  rules: [
    ...context2.rules,
    {
      id: nextId(context2, type + fqn2),
      expr: { ref: { model: fqn2 } },
      enabled: !0,
      type
    }
  ]
})), removeElementRules = (fqn2) => machine.assign(({ context: context2 }) => {
  const isRule = isRuleOf(fqn2);
  return {
    rules: context2.rules.filter((rule) => !isRule(rule))
  };
}), toggleElement = () => machine.enqueueActions(({ context: context2, event, enqueue }) => {
  assertEvent(event, "toggle.element");
  const isRuleOfTheElement = isRuleOf(event.id), lastRule = t$b(context2.rules);
  if (lastRule && isRuleOfTheElement(lastRule)) {
    enqueue.assign({
      rules: context2.rules.slice(0, -1)
    });
    return;
  }
  const state = deriveElementState(event.id, context2);
  switch (state.state) {
    case "disabled": {
    ...
    case "not-present": {
      enqueue(removeElementRules(event.id)), enqueue(addElementRules(event.id, "include"));
      break;
    }
    case "include-implicit": {
      enqueue(removeElementRules(event.id)), enqueue(addElementRules(event.id, "exclude"));
      break;
    }
    ...
    default:
      nonexhaustive$1(state);
  }
}), toggleRule = () => machine.assign(({ context: context2, event }) => (assertEvent(event, "toggle.rule"), {
  rules: context2.rules.map((rule) => rule.id === event.ruleId ? {
    ...rule,
    enabled: !rule.enabled
  } : rule)
})), deleteRule = () => machine.assign(({ context: context2, event }) => (assertEvent(event, "delete.rule"), {
  rules: context2.rules.filter((rule) => rule.id !== event.ruleId)
})), scheduleLayout = () => machine.raise({ type: "layout" }), idle = machine.createStateConfig({
  id: "idle",
  on: {
    "select.open": {
      ...to.selecting
...
}), selecting = machine.createStateConfig({
  id: "selecting",
  on: {
    "toggle.element": {
      actions: [
...
}), layouting = machine.createStateConfig({
  id: "layouting",
  always: {
    actions: scheduleLayout(),
    ...to.idle
  }
}), editor = machine.createStateConfig({
  initial: "selecting",
  states: {
    idle,
    selecting,
...
}), _adhocEditorLogic = machine.createMachine({
  id: "adhoc-editor",
...
}), adhocEditorLogic = _adhocEditorLogic, State = {
  read: () => JSON.parse(sessionStorage.getItem("adhoc-editor-state") || "null") ?? void 0,
  write: (state) => sessionStorage.setItem("adhoc-editor-state", JSON.stringify(state))
};
function AdhocEditorActorProvider({ children, service }) {
  const serviceRef = useRef(service);
  serviceRef.current = service;
  const provided = useMemo(() => ({
    actors: {
      service: fromPromise(({ input: input2 }) => serviceRef.current.process(input2))
    }
  }), []), actorRef = useActorRef(
  ...
  return useEffect(() => {
    ...
    return () => subscription.unsubscribe();
  }, [actorRef]), /* @__PURE__ */ jsx(AdhocEditorActorContextProvider, { value: actorRef, children });
}
const noop = () => {
}, defaultFeatures = {
  ...t$k(DefaultFeatures, () => !1),
  enableFitView: !0,
  enableReadOnly: !0
};
function LikeC4AdHocViewEditor({ service }) {
  const id = useId(), initialRef = useRef({
    fitView: !0,
    defaultNodes: [],
    defaultEdges: []
  });
  return /* @__PURE__ */ jsx(EnsureMantine, { children: /* @__PURE__ */ jsx(FramerMotionConfig, { children: /* @__PURE__ */ jsx(Profiler, { id: "LikeC4AdHocViewEditor", onRender: noop, children: /* @__PURE__ */ jsx(IconRendererProvider, { value: null, children: /* @__PURE__ */ jsx(AdhocEditorActorProvider, { service, children: /* @__PURE__ */ jsxs(DiagramFeatures, { features: defaultFeatures, children: [
    /* @__PURE__ */ jsx(LikeC4Styles, { id }),
    /* @__PURE__ */ jsx(TagStylesProvider, { rootSelector: `#${id}`, children: /* @__PURE__ */ jsx(RootContainer, { id, children: /* @__PURE__ */ jsxs(ReactFlowProvider, { ...initialRef.current, children: [
      /* @__PURE__ */ jsx(LikeC4AdHocView, { id }),
      /* @__PURE__ */ jsx(EditorPanel, {})
    ] }) }) })
  ] }) }) }) }) }) });
}
const LikeC4AdHocView = memo$1(({ id }) => {
  ...
  return /* @__PURE__ */ jsxs(
    DiagramActorProvider,
    {
      ...
      nodesSelectable: !0,
      children: [
        /* @__PURE__ */ jsx(LikeC4DiagramXYFlow, {}),
        /* @__PURE__ */ jsx(LikeC4AdHocEditorEvents, {})
      ]
    }
  );
}), LikeC4AdHocEditorEvents = memo$1(() => {
  const actorRef = useAdhocEditorActor(), diagram = useDiagram();
  return useEffect(() => {
