...
type PropValues = Record<string, Set<Primitive$2>>;
type PrimitiveSet = Set<Primitive$2>;
...
type $ZodStandardSchema<T> = StandardSchemaV1$1.Props<input$1<T>, output$1<T>>;
type SomeType = {
...
type $InferObjectInput<T extends $ZodLooseShape, Extra extends Record<string, unknown>> = string extends keyof T ? IsAny<T[keyof T]> extends true ? Record<string, unknown> : Record<string, input$1<T[keyof T]>> : keyof (T & Extra) extends never ? Record<string, never> : Prettify<{ -readonly [k in keyof T as T[k] extends OptionalInSchema ? never : k]: T[k]["_zod"]["input"] } & { -readonly [k in keyof T as T[k] extends OptionalInSchema ? k : never]?: T[k]["_zod"]["input"] } & Extra>;
...
interface $ZodOptionalInternals<T extends SomeType = $ZodType> extends $ZodTypeInternals<output$1<T> | undefined, input$1<T> | undefined> {
...
interface $ZodNullableInternals<T extends SomeType = $ZodType> extends $ZodTypeInternals<output$1<T> | null, input$1<T> | null> {
...
interface $ZodDefaultInternals<T extends SomeType = $ZodType> extends $ZodTypeInternals<NoUndefined<output$1<T>>, input$1<T> | undefined> {
  def: $ZodDefaultDef<T>;
  optin: "optional";
  optout?: "optional" | undefined;
  isst: never;
...
interface $ZodPrefaultInternals<T extends SomeType = $ZodType> extends $ZodTypeInternals<NoUndefined<output$1<T>>, input$1<T> | undefined> {
...
interface $ZodNonOptionalInternals<T extends SomeType = $ZodType> extends $ZodTypeInternals<NoUndefined<output$1<T>>, NoUndefined<input$1<T>>> {
...
interface $ZodReadonlyInternals<T extends SomeType = $ZodType> extends $ZodTypeInternals<MakeReadonly$1<output$1<T>>, MakeReadonly$1<input$1<T>>> {
...
interface ZodObject$1< /** @ts-ignore Cast variance */out Shape extends $ZodShape = $ZodLooseShape, out Config extends $ZodObjectConfig = $strip> extends _ZodType<$ZodObjectInternals<Shape, Config>>, $ZodObject<Shape, Config> {
  ...
  catchall<T extends SomeType>(schema: T): ZodObject$1<Shape, $catchall<T>>;
  /** @deprecated Use `z.looseObject()` or `.loose()` instead. */
  passthrough(): ZodObject$1<Shape, $loose>;
  /** Consider `z.looseObject(A.shape)` instead */
  loose(): ZodObject$1<Shape, $loose>;
...
interface ZodEnum$1< /** @ts-ignore Cast variance */out T extends EnumLike = EnumLike> extends _ZodType<$ZodEnumInternals<T>>, $ZodEnum<T> {
  ...
  exclude<const U extends readonly (keyof T)[]>(values: U, params?: string | $ZodEnumParams): ZodEnum$1<Flatten$1<Omit<T, U[number]>>>;
}
...
type SchemaOutput<S> = S extends ZodTypeAny ? TypeOf<S> : S extends $ZodType ? output$1<S> : never;
/**
 ...
 */
declare const TaskCreationParamsSchema: ZodObject$1<{
  /**
   * Time in milliseconds to keep task results available after completion.
   * If null, the task has unlimited lifetime until manually cleaned up.
   */
  ttl: ZodOptional$1<ZodUnion$1<readonly [ZodNumber, ZodNull]>>;
  /**
   * Time in milliseconds to wait between task status requests.
   */
  pollInterval: ZodOptional$1<ZodNumber>;
}, $loose>;
/**
 * Metadata for associating messages with a task.
 * Include this in the `_meta` field under the key `io.modelcontextprotocol/related-task`.
 */
declare const RelatedTaskMetadataSchema: ZodObject$1<{
  taskId: ZodString;
}, $strip>;
declare const RequestMetaSchema: ZodObject$1<{
  /**
   * If specified, the caller is requesting out-of-band progress notifications for this request (as represented by notifications/progress). The value of this parameter is an opaque token that will be attached to any subsequent notifications. The receiver is not obligated to provide these notifications.
   */
  progressToken: ZodOptional$1<ZodUnion$1<readonly [ZodString, ZodNumber]>>;
  /**
   * If specified, this request is related to the provided task.
   */
  "io.modelcontextprotocol/related-task": ZodOptional$1<ZodObject$1<{
    taskId: ZodString;
  }, $strip>>;
}, $loose>;
/**
 ...
 */
declare const RequestSchema: ZodObject$1<{
  method: ZodString;
  params: ZodOptional$1<ZodObject$1<{
    _meta: ZodOptional$1<ZodObject$1<{
      /**
       * If specified, the caller is requesting out-of-band progress notifications for this request (as represented by notifications/progress). The value of this parameter is an opaque token that will be attached to any subsequent notifications. The receiver is not obligated to provide these notifications.
       */
      progressToken: ZodOptional$1<ZodUnion$1<readonly [ZodString, ZodNumber]>>;
...
declare const NotificationSchema: ZodObject$1<{
  method: ZodString;
  params: ZodOptional$1<ZodObject$1<{
    _meta: ZodOptional$1<ZodObject$1<{
      /**
...
declare const ResultSchema: ZodObject$1<{
  /**
 ...
 */
declare const RequestIdSchema: ZodUnion$1<readonly [ZodString, ZodNumber]>;
/**
 * A request that expects a response.
 */
declare const JSONRPCRequestSchema: ZodObject$1<{
  method: ZodString;
  params: ZodOptional$1<ZodObject$1<{
    _meta: ZodOptional$1<ZodObject$1<{
      /**
 ...
 */
declare const JSONRPCNotificationSchema: ZodObject$1<{
  method: ZodString;
  params: ZodOptional$1<ZodObject$1<{
    _meta: ZodOptional$1<ZodObject$1<{
      /**
 ...
 */
declare const JSONRPCResultResponseSchema: ZodObject$1<{
  jsonrpc: ZodLiteral<"2.0">;
  id: ZodUnion$1<readonly [ZodString, ZodNumber]>;
  result: ZodObject$1<{
    /**
 ...
 */
declare const JSONRPCErrorResponseSchema: ZodObject$1<{
  jsonrpc: ZodLiteral<"2.0">;
  id: ZodOptional$1<ZodUnion$1<readonly [ZodString, ZodNumber]>>;
  error: ZodObject$1<{
    code: ZodNumber;
    message: ZodString;
...
declare const JSONRPCMessageSchema: ZodUnion$1<readonly [ZodObject$1<{
  method: ZodString;
  params: ZodOptional$1<ZodObject$1<{
    _meta: ZodOptional$1<ZodObject$1<{
      /**
 ...
 */
declare const ImplementationSchema: ZodObject$1<{
  version: ZodString;
  websiteUrl: ZodOptional$1<ZodString>;
  description: ZodOptional$1<ZodString>;
  icons: ZodOptional$1<ZodArray$1<ZodObject$1<{
    src: ZodString;
    mimeType: ZodOptional$1<ZodString>;
    sizes: ZodOptional$1<ZodArray$1<ZodString>>;
    theme: ZodOptional$1<ZodEnum$1<{
      light: "light";
      dark: "dark";
    }>>;
  }, $strip>>>;
 ...
 */
declare const ClientCapabilitiesSchema: ZodObject$1<{
  experimental: ZodOptional$1<ZodRecord<ZodString, ZodCustom<object, object>>>;
  sampling: ZodOptional$1<ZodObject$1<{
    context: ZodOptional$1<ZodCustom<object, object>>;
    tools: ZodOptional$1<ZodCustom<object, object>>;
  }, $strip>>;
  elicitation: ZodOptional$1<ZodPipe<ZodTransform<unknown, unknown>, ZodIntersection$1<ZodObject$1<{
    form: ZodOptional$1<ZodIntersection$1<ZodObject$1<{
      applyDefaults: ZodOptional$1<ZodBoolean>;
    }, $strip>, ZodRecord<ZodString, ZodUnknown>>>;
    url: ZodOptional$1<ZodCustom<object, object>>;
  }, $strip>, ZodOptional$1<ZodRecord<ZodString, ZodUnknown>>>>>;
  roots: ZodOptional$1<ZodObject$1<{
    listChanged: ZodOptional$1<ZodBoolean>;
  }, $strip>>;
  tasks: ZodOptional$1<ZodObject$1<{
    /**
     * Present if the client supports listing tasks.
     */
    list: ZodOptional$1<ZodCustom<object, object>>;
    /**
     * Present if the client supports cancelling tasks.
     */
    cancel: ZodOptional$1<ZodCustom<object, object>>;
    /**
     * Capabilities for task creation on specific request types.
     */
    requests: ZodOptional$1<ZodObject$1<{
      /**
       * Task support for sampling requests.
       */
      sampling: ZodOptional$1<ZodObject$1<{
        createMessage: ZodOptional$1<ZodCustom<object, object>>;
      }, $loose>>;
      /**
       * Task support for elicitation requests.
       */
      elicitation: ZodOptional$1<ZodObject$1<{
        create: ZodOptional$1<ZodCustom<object, object>>;
      }, $loose>>;
    }, $loose>>;
  }, $loose>>;
}, $strip>;
 ...
 */
declare const ServerCapabilitiesSchema: ZodObject$1<{
  experimental: ZodOptional$1<ZodRecord<ZodString, ZodCustom<object, object>>>;
  logging: ZodOptional$1<ZodCustom<object, object>>;
  completions: ZodOptional$1<ZodCustom<object, object>>;
  prompts: ZodOptional$1<ZodObject$1<{
    listChanged: ZodOptional$1<ZodBoolean>;
  }, $strip>>;
  resources: ZodOptional$1<ZodObject$1<{
    subscribe: ZodOptional$1<ZodBoolean>;
    listChanged: ZodOptional$1<ZodBoolean>;
  }, $strip>>;
  tools: ZodOptional$1<ZodObject$1<{
    listChanged: ZodOptional$1<ZodBoolean>;
  }, $strip>>;
  tasks: ZodOptional$1<ZodObject$1<{
    /**
    ...
    requests: ZodOptional$1<ZodObject$1<{
       ...
       */
      tools: ZodOptional$1<ZodObject$1<{
        call: ZodOptional$1<ZodCustom<object, object>>;
      }, $loose>>;
    }, $loose>>;
  }, $loose>>;
}, $strip>;
declare const ProgressSchema: ZodObject$1<{
  progress: ZodNumber;
  total: ZodOptional$1<ZodNumber>;
  message: ZodOptional$1<ZodString>;
}, $strip>;
/**
 * A pollable state object associated with a request.
 */
declare const TaskSchema: ZodObject$1<{
  taskId: ZodString;
  status: ZodEnum$1<{
    working: "working";
  ...
  ttl: ZodUnion$1<readonly [ZodNumber, ZodNull]>;
  createdAt: ZodString;
  lastUpdatedAt: ZodString;
  pollInterval: ZodOptional$1<ZodNumber>;
  statusMessage: ZodOptional$1<ZodString>;
}, $strip>;
/**
 * Result returned when a task is created, containing the task data wrapped in a task field.
 */
declare const CreateTaskResultSchema: ZodObject$1<{
  _meta: ZodOptional$1<ZodObject$1<{
    /**
     * If specified, the caller is requesting out-of-band progress notifications for this request (as represented by notifications/progress). The value of this parameter is an opaque token that will be attached to any subsequent notifications. The receiver is not obligated to provide these notifications.
     */
 ...
 */
declare const GetTaskRequestSchema: ZodObject$1<{
 ...
 */
declare const GetTaskResultSchema: ZodObject$1<{
  _meta: ZodOptional$1<ZodObject$1<{
    /**
     * If specified, the caller is requesting out-of-band progress notifications for this request (as represented by notifications/progress). The value of this parameter is an opaque token that will be attached to any subsequent notifications. The receiver is not obligated to provide these notifications.
     */
 ...
 */
declare const GetTaskPayloadRequestSchema: ZodObject$1<{
 ...
 */
declare const ListTasksResultSchema: ZodObject$1<{
  _meta: ZodOptional$1<ZodObject$1<{
    /**
     * If specified, the caller is requesting out-of-band progress notifications for this request (as represented by notifications/progress). The value of this parameter is an opaque token that will be attached to any subsequent notifications. The receiver is not obligated to provide these notifications.
     */
 ...
 */
declare const CancelTaskResultSchema: ZodObject$1<{
  _meta: ZodOptional$1<ZodObject$1<{
    /**
     * If specified, the caller is requesting out-of-band progress notifications for this request (as represented by notifications/progress). The value of this parameter is an opaque token that will be attached to any subsequent notifications. The receiver is not obligated to provide these notifications.
     */
 ...
 */
declare const ResourceSchema: ZodObject$1<{
  uri: ZodString;
  description: ZodOptional$1<ZodString>;
  mimeType: ZodOptional$1<ZodString>;
  annotations: ZodOptional$1<ZodObject$1<{
    audience: ZodOptional$1<ZodArray$1<ZodEnum$1<{
      user: "user";
      assistant: "assistant";
    }>>>;
    priority: ZodOptional$1<ZodNumber>;
    lastModified: ZodOptional$1<ZodISODateTime>;
  }, $strip>>;
  _meta: ZodOptional$1<ZodObject$1<{}, $loose>>;
  icons: ZodOptional$1<ZodArray$1<ZodObject$1<{
    src: ZodString;
    mimeType: ZodOptional$1<ZodString>;
    sizes: ZodOptional$1<ZodArray$1<ZodString>>;
 ...
 */
declare const ListResourcesResultSchema: ZodObject$1<{
  _meta: ZodOptional$1<ZodObject$1<{
    /**
     * If specified, the caller is requesting out-of-band progress notifications for this request (as represented by notifications/progress). The value of this parameter is an opaque token that will be attached to any subsequent notifications. The receiver is not obligated to provide these notifications.
     */
  ...
  nextCursor: ZodOptional$1<ZodString>;
  resources: ZodArray$1<ZodObject$1<{
    uri: ZodString;
    description: ZodOptional$1<ZodString>;
    mimeType: ZodOptional$1<ZodString>;
    annotations: ZodOptional$1<ZodObject$1<{
 ...
 */
declare const ReadResourceResultSchema: ZodObject$1<{
  _meta: ZodOptional$1<ZodObject$1<{
    /**
     * If specified, the caller is requesting out-of-band progress notifications for this request (as represented by notifications/progress). The value of this parameter is an opaque token that will be attached to any subsequent notifications. The receiver is not obligated to provide these notifications.
     */
  ...
  contents: ZodArray$1<ZodUnion$1<readonly [ZodObject$1<{
    uri: ZodString;
    mimeType: ZodOptional$1<ZodString>;
 ...
 */
declare const ResourceUpdatedNotificationSchema: ZodObject$1<{
 ...
 */
declare const GetPromptResultSchema: ZodObject$1<{
  _meta: ZodOptional$1<ZodObject$1<{
    /**
     * If specified, the caller is requesting out-of-band progress notifications for this request (as represented by notifications/progress). The value of this parameter is an opaque token that will be attached to any subsequent notifications. The receiver is not obligated to provide these notifications.
     */
  ...
  description: ZodOptional$1<ZodString>;
  messages: ZodArray$1<ZodObject$1<{
    role: ZodEnum$1<{
      user: "user";
      assistant: "assistant";
    }>;
    content: ZodUnion$1<readonly [ZodObject$1<{
      ...
      resource: ZodUnion$1<readonly [ZodObject$1<{
        uri: ZodString;
        mimeType: ZodOptional$1<ZodString>;
        _meta: ZodOptional$1<ZodRecord<ZodString, ZodUnknown>>;
        text: ZodString;
 ...
 */
declare const ToolAnnotationsSchema: ZodObject$1<{
  title: ZodOptional$1<ZodString>;
  readOnlyHint: ZodOptional$1<ZodBoolean>;
  destructiveHint: ZodOptional$1<ZodBoolean>;
  idempotentHint: ZodOptional$1<ZodBoolean>;
  openWorldHint: ZodOptional$1<ZodBoolean>;
}, $strip>;
/**
 * Execution-related properties for a tool.
 */
declare const ToolExecutionSchema: ZodObject$1<{
  taskSupport: ZodOptional$1<ZodEnum$1<{
    optional: "optional";
    required: "required";
    forbidden: "forbidden";
  }>>;
 ...
 */
declare const ToolSchema: ZodObject$1<{
  description: ZodOptional$1<ZodString>;
  inputSchema: ZodObject$1<{
    type: ZodLiteral<"object">;
    properties: ZodOptional$1<ZodRecord<ZodString, ZodCustom<object, object>>>;
    required: ZodOptional$1<ZodArray$1<ZodString>>;
  }, $catchall<ZodUnknown>>;
  outputSchema: ZodOptional$1<ZodObject$1<{
    type: ZodLiteral<"object">;
    properties: ZodOptional$1<ZodRecord<ZodString, ZodCustom<object, object>>>;
    required: ZodOptional$1<ZodArray$1<ZodString>>;
  }, $catchall<ZodUnknown>>>;
  ...
  execution: ZodOptional$1<ZodObject$1<{
    taskSupport: ZodOptional$1<ZodEnum$1<{
      optional: "optional";
      required: "required";
      forbidden: "forbidden";
 ...
 */
declare const CallToolResultSchema: ZodObject$1<{
  _meta: ZodOptional$1<ZodObject$1<{
    /**
     * If specified, the caller is requesting out-of-band progress notifications for this request (as represented by notifications/progress). The value of this parameter is an opaque token that will be attached to any subsequent notifications. The receiver is not obligated to provide these notifications.
     */
  ...
  content: ZodDefault$1<ZodArray$1<ZodUnion$1<readonly [ZodObject$1<{
    type: ZodLiteral<"text">;
    text: ZodString;
    annotations: ZodOptional$1<ZodObject$1<{
      audience: ZodOptional$1<ZodArray$1<ZodEnum$1<{
  ...
  structuredContent: ZodOptional$1<ZodRecord<ZodString, ZodUnknown>>;
  isError: ZodOptional$1<ZodBoolean>;
}, $loose>;
/**
 * Notification of a log message passed from server to client. If no logging/setLevel request has been sent from the client, the server MAY decide which messages to send automatically.
 */
declare const LoggingMessageNotificationSchema: ZodObject$1<{
  ...
  params: ZodObject$1<{
    ...
    logger: ZodOptional$1<ZodString>;
    data: ZodUnknown;
  }, $strip>;
}, $strip>;
/**
 ...
 */
declare const CreateMessageRequestParamsSchema: ZodObject$1<{
  _meta: ZodOptional$1<ZodObject$1<{
    /**
     * If specified, the caller is requesting out-of-band progress notifications for this request (as represented by notifications/progress). The value of this parameter is an opaque token that will be attached to any subsequent notifications. The receiver is not obligated to provide these notifications.
     */
  ...
  task: ZodOptional$1<ZodObject$1<{
    ttl: ZodOptional$1<ZodNumber>;
  }, $strip>>;
  messages: ZodArray$1<ZodObject$1<{
    role: ZodEnum$1<{
      user: "user";
    ...
    content: ZodUnion$1<readonly [ZodDiscriminatedUnion<[ZodObject$1<{
      type: ZodLiteral<"text">;
      text: ZodString;
      annotations: ZodOptional$1<ZodObject$1<{
        audience: ZodOptional$1<ZodArray$1<ZodEnum$1<{
      ...
      structuredContent: ZodOptional$1<ZodObject$1<{}, $loose>>;
      isError: ZodOptional$1<ZodBoolean>;
      _meta: ZodOptional$1<ZodRecord<ZodString, ZodUnknown>>;
    }, $strip>]>, ZodArray$1<ZodDiscriminatedUnion<[ZodObject$1<{
      type: ZodLiteral<"text">;
      text: ZodString;
      annotations: ZodOptional$1<ZodObject$1<{
        audience: ZodOptional$1<ZodArray$1<ZodEnum$1<{
  ...
  modelPreferences: ZodOptional$1<ZodObject$1<{
    hints: ZodOptional$1<ZodArray$1<ZodObject$1<{
      name: ZodOptional$1<ZodString>;
    }, $strip>>>;
    costPriority: ZodOptional$1<ZodNumber>;
    speedPriority: ZodOptional$1<ZodNumber>;
    intelligencePriority: ZodOptional$1<ZodNumber>;
  }, $strip>>;
  systemPrompt: ZodOptional$1<ZodString>;
  includeContext: ZodOptional$1<ZodEnum$1<{
    none: "none";
    thisServer: "thisServer";
    allServers: "allServers";
  }>>;
  temperature: ZodOptional$1<ZodNumber>;
  maxTokens: ZodNumber;
  stopSequences: ZodOptional$1<ZodArray$1<ZodString>>;
  metadata: ZodOptional$1<ZodCustom<object, object>>;
  tools: ZodOptional$1<ZodArray$1<ZodObject$1<{
    description: ZodOptional$1<ZodString>;
    inputSchema: ZodObject$1<{
      type: ZodLiteral<"object">;
      properties: ZodOptional$1<ZodRecord<ZodString, ZodCustom<object, object>>>;
  ...
  toolChoice: ZodOptional$1<ZodObject$1<{
    mode: ZodOptional$1<ZodEnum$1<{
      required: "required";
      auto: "auto";
      none: "none";
    }>>;
 ...
 */
declare const CreateMessageRequestSchema: ZodObject$1<{
 ...
 */
declare const CreateMessageResultSchema: ZodObject$1<{
  _meta: ZodOptional$1<ZodObject$1<{
    /**
     * If specified, the caller is requesting out-of-band progress notifications for this request (as represented by notifications/progress). The value of this parameter is an opaque token that will be attached to any subsequent notifications. The receiver is not obligated to provide these notifications.
     */
  ...
  model: ZodString;
  stopReason: ZodOptional$1<ZodUnion$1<[ZodEnum$1<{
    maxTokens: "maxTokens";
    endTurn: "endTurn";
  ...
  content: ZodDiscriminatedUnion<[ZodObject$1<{
    type: ZodLiteral<"text">;
    text: ZodString;
    annotations: ZodOptional$1<ZodObject$1<{
      audience: ZodOptional$1<ZodArray$1<ZodEnum$1<{
 ...
 */
declare const CreateMessageResultWithToolsSchema: ZodObject$1<{
  _meta: ZodOptional$1<ZodObject$1<{
    /**
     * If specified, the caller is requesting out-of-band progress notifications for this request (as represented by notifications/progress). The value of this parameter is an opaque token that will be attached to any subsequent notifications. The receiver is not obligated to provide these notifications.
     */
 ...
 */
declare const ElicitRequestFormParamsSchema: ZodObject$1<{
  _meta: ZodOptional$1<ZodObject$1<{
    /**
     * If specified, the caller is requesting out-of-band progress notifications for this request (as represented by notifications/progress). The value of this parameter is an opaque token that will be attached to any subsequent notifications. The receiver is not obligated to provide these notifications.
     */
  ...
  mode: ZodOptional$1<ZodLiteral<"form">>;
  message: ZodString;
  requestedSchema: ZodObject$1<{
    type: ZodLiteral<"object">;
    properties: ZodRecord<ZodString, ZodUnion$1<readonly [ZodUnion$1<readonly [ZodObject$1<{
      type: ZodLiteral<"string">;
      title: ZodOptional$1<ZodString>;
      description: ZodOptional$1<ZodString>;
      enum: ZodArray$1<ZodString>;
      enumNames: ZodOptional$1<ZodArray$1<ZodString>>;
      default: ZodOptional$1<ZodString>;
    }, $strip>, ZodUnion$1<readonly [ZodObject$1<{
      type: ZodLiteral<"string">;
      title: ZodOptional$1<ZodString>;
      description: ZodOptional$1<ZodString>;
      enum: ZodArray$1<ZodString>;
      ...
      title: ZodOptional$1<ZodString>;
      description: ZodOptional$1<ZodString>;
      minItems: ZodOptional$1<ZodNumber>;
      maxItems: ZodOptional$1<ZodNumber>;
      items: ZodObject$1<{
        type: ZodLiteral<"string">;
        enum: ZodArray$1<ZodString>;
      }, $strip>;
      default: ZodOptional$1<ZodArray$1<ZodString>>;
    }, $strip>, ZodObject$1<{
      type: ZodLiteral<"array">;
      title: ZodOptional$1<ZodString>;
      description: ZodOptional$1<ZodString>;
      ...
      title: ZodOptional$1<ZodString>;
      description: ZodOptional$1<ZodString>;
      default: ZodOptional$1<ZodBoolean>;
    }, $strip>, ZodObject$1<{
      type: ZodLiteral<"string">;
      title: ZodOptional$1<ZodString>;
      description: ZodOptional$1<ZodString>;
      minLength: ZodOptional$1<ZodNumber>;
      maxLength: ZodOptional$1<ZodNumber>;
      format: ZodOptional$1<ZodEnum$1<{
        date: "date";
        uri: "uri";
        email: "email";
        "date-time": "date-time";
      ...
      title: ZodOptional$1<ZodString>;
      description: ZodOptional$1<ZodString>;
      minimum: ZodOptional$1<ZodNumber>;
      maximum: ZodOptional$1<ZodNumber>;
      default: ZodOptional$1<ZodNumber>;
    }, $strip>]>>;
    required: ZodOptional$1<ZodArray$1<ZodString>>;
  }, $strip>;
}, $strip>;
 ...
 */
declare const ElicitRequestURLParamsSchema: ZodObject$1<{
  _meta: ZodOptional$1<ZodObject$1<{
    /**
     * If specified, the caller is requesting out-of-band progress notifications for this request (as represented by notifications/progress). The value of this parameter is an opaque token that will be attached to any subsequent notifications. The receiver is not obligated to provide these notifications.
     */
 ...
 */
declare const ElicitResultSchema: ZodObject$1<{
  _meta: ZodOptional$1<ZodObject$1<{
    /**
     * If specified, the caller is requesting out-of-band progress notifications for this request (as represented by notifications/progress). The value of this parameter is an opaque token that will be attached to any subsequent notifications. The receiver is not obligated to provide these notifications.
     */
  ...
  content: ZodPipe<ZodTransform<{} | undefined, unknown>, ZodOptional$1<ZodRecord<ZodString, ZodUnion$1<readonly [ZodString, ZodNumber, ZodBoolean, ZodArray$1<ZodString>]>>>>;
}, $loose>;
/**
 * Sent from the server to request a list of root URIs from the client.
 */
declare const ListRootsRequestSchema: ZodObject$1<{
...
declare const ServerRequestSchema: ZodUnion$1<readonly [ZodObject$1<{
  ...
  params: ZodUnion$1<readonly [ZodObject$1<{
    _meta: ZodOptional$1<ZodObject$1<{
      /**
       * If specified, the caller is requesting out-of-band progress notifications for this request (as represented by notifications/progress). The value of this parameter is an opaque token that will be attached to any subsequent notifications. The receiver is not obligated to provide these notifications.
       */
  ...
  params: ZodOptional$1<ZodObject$1<{
    ...
    cursor: ZodOptional$1<ZodString>;
  }, $strip>>;
...
declare const ServerNotificationSchema: ZodUnion$1<readonly [ZodObject$1<{
  ...
  params: ZodObject$1<{
    ...
    requestId: ZodOptional$1<ZodUnion$1<readonly [ZodString, ZodNumber]>>;
    reason: ZodOptional$1<ZodString>;
  }, $strip>;
}, $strip>, ZodObject$1<{
  method: ZodLiteral<"notifications/progress">;
  params: ZodObject$1<{
    progressToken: ZodUnion$1<readonly [ZodString, ZodNumber]>;
    progress: ZodNumber;
    total: ZodOptional$1<ZodNumber>;
    message: ZodOptional$1<ZodString>;
    _meta: ZodOptional$1<ZodObject$1<{
...
declare const ServerResultSchema: ZodUnion$1<readonly [ZodObject$1<{
  /**
   * See [MCP specification](https://github.com/modelcontextprotocol/modelcontextprotocol/blob/47339c03c143bb4ec01a26e721a1b8fe66634ebe/docs/specification/draft/basic/index.mdx#general-fields)
   * for notes on _meta usage.
   */
  ...
  nextCursor: ZodOptional$1<ZodString>;
  prompts: ZodArray$1<ZodObject$1<{
    description: ZodOptional$1<ZodString>;
    arguments: ZodOptional$1<ZodArray$1<ZodObject$1<{
      name: ZodString;
      description: ZodOptional$1<ZodString>;
  ...
  nextCursor: ZodOptional$1<ZodString>;
  resourceTemplates: ZodArray$1<ZodObject$1<{
...
type Infer<Schema extends ZodType$1> = Flatten<output$1<Schema>>;
/**
 ...
 * @experimental
 */
type BaseToolCallback$1<SendResultT extends Result$1, ExtraT extends RequestHandlerExtra<ServerRequest, ServerNotification>, Args extends undefined | ZodRawShapeCompat | AnySchema = undefined> = Args extends ZodRawShapeCompat ? (args: ShapeOutput<Args>, extra: ExtraT) => SendResultT | Promise<SendResultT> : Args extends AnySchema ? (args: unknown, extra: ExtraT) => SendResultT | Promise<SendResultT> : (extra: ExtraT) => SendResultT | Promise<SendResultT>;
/**
 * Handler for creating a task.
 * @experimental
 */
type CreateTaskRequestHandler<SendResultT extends Result$1, Args extends undefined | ZodRawShapeCompat | AnySchema = undefined> = BaseToolCallback$1<SendResultT, CreateTaskRequestHandlerExtra, Args>;
/**
 * Handler for task operations (get, getResult).
 * @experimental
 */
type TaskRequestHandler<SendResultT extends Result$1, Args extends undefined | ZodRawShapeCompat | AnySchema = undefined> = BaseToolCallback$1<SendResultT, TaskRequestHandlerExtra, Args>;
/**
 ...
 */
interface ResultMessage<T extends Result$1> extends BaseResponseMessage {
  type: 'result';
  result: T;
}
/**
 ...
 */
declare abstract class Protocol<SendRequestT extends Request, SendNotificationT extends Notification, SendResultT extends Result$1> {
  private _options?;
  private _transport?;
 ...
 * @experimental
 */
declare class ExperimentalServerTasks<RequestT extends Request = Request, NotificationT extends Notification = Notification, ResultT extends Result$1 = Result$1> {
 ...
 */
declare class Server<RequestT extends Request = Request, NotificationT extends Notification = Notification, ResultT extends Result$1 = Result$1> extends Protocol<ServerRequest | RequestT, ServerNotification | NotificationT, ServerResult | ResultT> {
  private _serverInfo;
