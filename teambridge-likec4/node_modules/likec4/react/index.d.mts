 ...
 */
export declare function DefaultHandles({ direction }: {
...
export declare type DiagramEvents = HotKeyEvent | MediaPrintEvent | {
    ...
    edges?: EdgeChange<Types.Edge>[];
    nodes?: NodeChange<Types.Node>[];
} | {
 ...
 * ```
 */
export declare function ElementActions({ extraButtons, ...props }: ElementActionsProps): JSX.Element;
 ...
 * ```
 */
export declare function ElementData({ data }: ElementDataProps): JSX.Element;

export declare namespace ElementData {
    var Root: ForwardRefExoticComponent<HTMLAttributes<HTMLDivElement> & ElementDataProps & RefAttributes<HTMLDivElement>>;
